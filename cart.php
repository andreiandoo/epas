            ...
            <div class="lg:w-2/3">
                ...
                <div id="promo-section" class="hidden p-5 mt-6 bg-white border rounded-2xl border-border">
                    ...
                    <div class="flex gap-3">
                        ...
                        <button onclick="CartPage.applyPromo()" class="px-6 py-3 font-semibold text-white transition-colors bg-secondary rounded-xl hover:bg-secondary/90"  aria-label="Aplica codul promoțional">
                            Aplică
                        </button>
                    </div>
                ...
                <div id="summary-section" class="hidden sticky top-[140px]">
                    <div class="overflow-hidden bg-white border rounded-2xl border-border">
                        ...
                        <div class="p-3">
                            ...
                            <!-- Checkout Button -->
                            <a href="/finalizare" id="checkoutBtn" class="flex items-center justify-center w-full gap-2 py-4 mt-6 text-lg font-bold text-white btn-primary bg-primary rounded-xl">
                                Continuă spre plată
