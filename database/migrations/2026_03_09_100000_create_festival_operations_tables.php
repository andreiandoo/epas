...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('wristband_transactions')) {
        ...
        // ── Festival volunteers ─────────────────────────────
        if (!Schema::hasTable('festival_volunteers')) {
        ...
        // ── Volunteer shifts ────────────────────────────────
        if (!Schema::hasTable('volunteer_shifts')) {
        ...
        if (!Schema::hasTable('festival_transport_shuttles')) {
        ...
        // ── Festival reviews ────────────────────────────────
        if (!Schema::hasTable('festival_reviews')) {
