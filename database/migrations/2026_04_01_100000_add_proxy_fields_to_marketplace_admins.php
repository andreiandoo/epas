...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('marketplace_admins', function (Blueprint $table) {
            ...
            $table->string('proxy_sector')->nullable()->after('proxy_city');
            $table->string('proxy_id_series')->nullable()->after('proxy_sector');
    ...
    public function down(): void
    {
        Schema::table('marketplace_admins', function (Blueprint $table) {
            $table->dropColumn([
                ...
                'proxy_country', 'proxy_county', 'proxy_city', 'proxy_sector',
