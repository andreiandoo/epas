...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('merchandise_items', function (Blueprint $table) {
            ...
            $table->unsignedDecimal('quantity', 12, 3);            // total quantity imported
            $table->unsignedInteger('acquisition_price_cents');     // per unit, excl. TVA
            $table->string('currency', 3)->default('RON');
            $table->unsignedDecimal('vat_rate', 5, 2)->default(19); // TVA %
        ...
        Schema::create('merchandise_allocations', function (Blueprint $table) {
            ...
            $table->unsignedDecimal('quantity_allocated', 12, 3);
            $table->unsignedDecimal('quantity_returned', 12, 3)->default(0);
