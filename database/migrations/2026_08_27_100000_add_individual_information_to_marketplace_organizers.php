...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('marketplace_organizers', function (Blueprint $table) {
            ...
            $table->string('individual_id_series', 5)->nullable()->after('individual_cnp');
            $table->string('individual_id_number', 20)->nullable()->after('individual_id_series');
            $table->text('individual_address')->nullable()->after('individual_id_number');
