...
function getRoleBg(role) {
  switch (role) {
    ...
    default: return 'rgba(20,10,10,0.05)';
  }
}
...
function getRoleBorder(role) {
  switch (role) {
    ...
    default: return 'rgba(20,10,10,0.08)';
  }
}
...
function getStatusBg(status) {
  switch (status) {
    ...
    case 'inactive': return 'rgba(20,10,10,0.05)';
    default: return 'rgba(20,10,10,0.05)';
  }
}
...
function getStatusBorder(status) {
  switch (status) {
    ...
    case 'inactive': return 'rgba(20,10,10,0.08)';
    default: return 'rgba(20,10,10,0.08)';
  }
}
    ...
    <View style={[styles.memberCard, isExpanded && styles.memberCardExpanded]}>
      ...
      <View style={styles.memberBottom}>
        ...
        {assignedGate ? (
          ...
          <TouchableOpacity
            style={[styles.gateBadge, { backgroundColor: 'rgba(20,10,10,0.05)', borderColor: colors.border }]}
            onPress={onToggleExpand}
            activeOpacity={0.7}
          >
