    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.scannerWrap}>
        ...
        <View style={styles.scannerFrame}>
          <ScanCorner position="topLeft" color={isScanning ? colors.purple : 'rgba(20,10,10,0.3)'} />
          <ScanCorner position="topRight" color={isScanning ? colors.purple : 'rgba(20,10,10,0.3)'} />
          <ScanCorner position="bottomLeft" color={isScanning ? colors.purple : 'rgba(20,10,10,0.3)'} />
          <ScanCorner position="bottomRight" color={isScanning ? colors.purple : 'rgba(20,10,10,0.3)'} />
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  header: { padding: 16, borderBottomWidth: 1, borderBottomColor: 'rgba(20,10,10,0.05)' },
  ...
  scannerIdle: { justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(20,10,10,0.03)' },
  ...
  resultHeader: {
    ...
    padding: 16,
    borderBottomWidth: 1,
    borderBottomColor: 'rgba(20,10,10,0.05)',
  },
  resultTitle: { color: colors.textPrimary, fontSize: 16, fontWeight: '700' },
  closeBtn: { padding: 6, borderRadius: 20, backgroundColor: 'rgba(20,10,10,0.05)' },
  ...
  noteCard: { backgroundColor: 'rgba(20,10,10,0.03)', padding: 10, borderRadius: 10, marginBottom: 6 },
