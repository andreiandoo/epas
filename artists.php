...
const ArtistsPage = {
    ...
    renderFeaturedCard(artist) {
        ...
        const totalFollowers = (artist.stats?.spotify_listeners || 0) +
                                (artist.stats?.instagram_followers || 0) +
                              (artist.stats?.facebook_followers || 0) +
                              (artist.stats?.youtube_subscribers || 0) +
                              (artist.stats?.tiktok_followers || 0);
