...
<!-- Top Bar -->
<div class="bg-secondary text-white text-sm py-2.5">
    <div class="flex items-center justify-between px-4 mx-auto max-w-7xl">
        <p class="items-center hidden gap-2 sm:flex">
            ...
            <span id="eventsCountBanner">Peste 500+ evenimente disponibile in toata Romania</span>
        </p>
        <div class="flex items-center gap-6 ml-auto">
            ...
            <a href="/organizer/landing" class="hover:text-primary-light transition-colors flex items-center gap-1.5">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
