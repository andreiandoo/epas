...
<head>
    ...
    <title>Confirma adresa de email - <?= $site_name ?? 'bilete.online' ?></title>
</head>
<body style="margin: 0; padding: 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #F8FAFC; -webkit-font-smoothing: antialiased;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden;">Confirma adresa de email pentru a activa contul tau <?= $site_name ?? 'bilete.online' ?>.</div>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 16px;">
                                        <span style="display: inline-block; background-color: rgba(255,255,255,0.2); border-radius: 50%; padding: 16px; font-size: 28px;">ðŸ“§</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #FEF3C7; border-radius: 12px;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <p style="margin: 0 0 8px 0; color: #92400E; font-weight: 600; font-size: 14px;">âš ï¸ Link-ul expira in 24 de ore</p>
                                        <p style="margin: 0; color: #A16207; font-size: 13px;">Daca nu ai solicitat acest email, poti ignora acest mesaj in siguranta.</p>
                                    </td>
                                </tr>
                            </table>

                            <p style="margin: 24px 0 0 0; color: #64748B; font-size: 14px; line-height: 1.6;">Ai nevoie de ajutor? Contacteaza-ne la <a href="mailto:<?= $support_email ?? 'suport@bilete.online' ?>" style="color: #A51C30; text-decoration: none;"><?= $support_email ?? 'suport@bilete.online' ?></a></p>
