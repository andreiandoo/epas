...
export const VEN={
  ...
  export const I={
    ...
    bed:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 21V5a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16"/><path d="M2 21h20"/><path d="M8 7h.01M12 7h.01M16 7h.01M8 11h.01M12 11h.01M16 11h.01"/><path d="M10 21v-4a2 2 0 0 1 4 0v4"/></svg>',
    car:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.4 2.6 2.8 9.5a1 1 0 0 0 .07 1.88l7.3 2.45 2.45 7.3a1 1 0 0 0 1.88.07l6.9-18.6a1 1 0 0 0-1-1z"/><path d="m10.2 13.8 4.4-4.4"/></svg>',
