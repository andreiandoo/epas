    ...
    <main class="flex-1 p-4 lg:p-8">
        <div class="w-full mx-auto space-y-6 lg:space-y-8" style="max-width:1500px;">
            ...
            <section>
                ...
                <div id="pn-events-grid" class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                    <!-- skeletons -->
                    <?php for ($i = 0; $i < 3; $i++): ?>
...
const OrgPanouNou = {
    ...
    actions(e) {
        ...
        out.push(btn(`/organizator/servicii?event=${e.id}`, 'Promovează', 'bg-amber-50 text-amber-700 border-amber-200 hover:bg-amber-100', 'M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z'));
        const slug = e.slug || '';
