        ...
        <main class="flex-1 p-4 lg:p-8">
            ...
            <div class="space-y-6">
                ...
                <div id="payments" class="overflow-hidden bg-white border rounded-2xl border-border">
                    ...
                    <div class="divide-y divide-border">
                        <div class="faq-item"><button onclick="toggleFaq(this)" class="flex items-center justify-between w-full p-6 text-left hover:bg-surface"><span class="font-medium text-secondary">Care sunt comisioanele <?= SITE_NAME ?>?</span><svg class="w-5 h-5 transition-transform text-muted faq-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg></button><div class="hidden px-6 pb-6 faq-content"><ul class="space-y-2 list-disc list-inside text-muted"><li><strong>1%</strong> - organizatori exclusivi</li><li><strong>2%</strong> - model mixt</li><li><strong>3%</strong> - reselleri</li></ul><p class="mt-2 text-muted">Plus taxe legale: 1% Crucea Rosie, 5% timbru muzical.</p></div></div>
                        <div class="faq-item"><button onclick="toggleFaq(this)" class="flex items-center justify-between w-full p-6 text-left hover:bg-surface"><span class="font-medium text-secondary">Cand primesc banii din vanzari?</span><svg class="w-5 h-5 transition-transform text-muted faq-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg></button><div class="hidden px-6 pb-6 faq-content"><p class="text-muted">Vanzarile sunt disponibile dupa 7 zile. Poti solicita plata din Finante cand balanta depaseste 100 RON. Transferurile se proceseaza in 2-3 zile lucratoare.</p></div></div>
