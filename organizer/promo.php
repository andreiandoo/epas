    ...
    <div id="promo-modal" class="fixed inset-0 z-50 items-center justify-center hidden p-4 bg-black/50">
        <div class="bg-white rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onsubmit="savePromoCode(event)" class="p-6 space-y-4">
                ...
                <div><label class="label">Aplicabil Pentru</label><select id="promo-event" class="w-full input"><option value="">Toate evenimentele</option></select></div>
                <div id="ticket-type-container" class="hidden"><label class="label">Tip Bilet</label><select id="promo-ticket-type" class="w-full input"><option value="">Toate tipurile de bilete</option></select><p class="mt-1 text-sm text-muted">Optional: aplica doar pentru un anumit tip de bilet</p></div>
