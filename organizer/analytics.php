...
?>
    ...
    <div class="flex flex-col flex-1 min-h-screen lg:ml-0">
        ...
        <main class="flex-1 p-4 lg:p-8">
            <!-- Tracking Activated Success Banner -->
            <?php if (isset($_GET['tracking_activated']) && $_GET['tracking_activated'] === '1'): ?>
            <div id="tracking-success-banner" class="bg-blue-50 border border-blue-200 rounded-2xl p-4 mb-6">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1">
                        <p class="font-semibold text-blue-900">Tracking Activat cu Succes!</p>
                        <p class="text-sm text-blue-700">Pixelii de tracking sunt acum activi pentru acest eveniment. Conversiile vor fi monitorizate automat.</p>
                    </div>
                    <button onclick="this.parentElement.parentElement.remove()" class="p-2 hover:bg-blue-100 rounded-lg">
                        <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
                    </button>
                </div>
            </div>
            <?php endif; ?>
