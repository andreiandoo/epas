...
export default class ErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    ...
    // Ship to Sentry (no-op if not initialized). componentStack helps a lot
    // when the error message alone isn't enough to pinpoint the tree spot.
    captureError(error, {
