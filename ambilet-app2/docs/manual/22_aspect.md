...
## 1. Cum ajungi la Aspect

**Setări → Aspect**. Vezi 3 opțiuni cu radio button.

<!-- SCREENSHOT: Setări → Aspect cu 3 radio buttons + descriere per opțiune -->
![Setări Aspect](./screenshots/22-settings.png)
...
Aceeași structură, dar cu:
- **Text mai închis** (negru total în loc de gri închis)
- **Borduri mai vizibile** (border-uri mai groase)
- Contrast crescut general

Recomandat pentru:
- Lumină slabă / dusk (dar nu noapte totală)
- Persoane cu vedere mai slabă
- Ecrane vechi cu contrast redus

### 🌙 Noapte

**Fundal întunecat** (aproape negru), text alb, roșu brand păstrat.
Recomandat pentru:
- Festivaluri de seară / noapte
- Cluburi întunecate
- Lumini stroboscopice / scenă puternică (evită orbirea)

---

## 3. Cum schimbi tema

**Tap pe opțiunea dorită** → apare Alert:
...
📖 [Capitolul 23 — Securitate (auto-logout) →](./23_securitate.md)
