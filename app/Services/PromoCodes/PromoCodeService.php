...
class PromoCodeService
{
    ...
    public function create(string $tenantId, array $data): array
    {
        ...
        DB::table('promo_codes')->insert([
            ...
            'is_public' => $data['is_public'] ?? ($data['customer_id'] ? false : true),
            'combinable' => $data['combinable'] ?? false,
            'exclude_combinations' => isset($data['exclude_combinations']) ? json_encode($data['exclude_combinations']) : null,
    ...
    protected function formatPromoCode(object $promoCode): array
    {
        return [
            ...
            'tags' => isset($promoCode->tags) ? json_decode($promoCode->tags, true) : null,
            'customer_id' => $promoCode->customer_id ?? null,
            'referral_source' => $promoCode->referral_source ?? null,
            'campaign_id' => $promoCode->campaign_id ?? null,
            'variant' => $promoCode->variant ?? null,
            'conversion_rate' => isset($promoCode->conversion_rate) ? (float) $promoCode->conversion_rate : null,
            'name' => $promoCode->name,
            ...
            'combinable' => isset($promoCode->combinable) ? (bool) $promoCode->combinable : false,
            'exclude_combinations' => isset($promoCode->exclude_combinations) ? json_decode($promoCode->exclude_combinations, true) : null,
