        ...
        return [
            ...
            'ticket' => [
                ...
                'variables' => [
                    ...
                    [
                        'path' => 'ticket.commission_included',
                        'label' => 'Commission (Included)',
                        'description' => 'Commission amount when included in ticket price',
                        'type' => 'currency',
                        'example' => '5.00 RON',
                    ],
                    [
                        'path' => 'ticket.commission_on_top',
                        'label' => 'Commission (On Top)',
                        'description' => 'Commission amount when added on top of ticket price',
                        'type' => 'currency',
                        'example' => '5.00 RON',
                    ],
                    [
    ...
    public function getSampleData(): array
    {
        return [
            ...
            'ticket' => [
                ...
                'commission_included' => '14.95 RON',
                'commission_on_top' => '14.95 RON',
