    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            @media (max-width: 1023.98px) {
                ...
                /* Filament hides .fi-sidebar-item-label when the primary sidebar is
                   collapsed (isOpen=false); on mobile that also blanks the cloned
                   labels in the flyout, leaving icon-only rows. Force them back so
                   the sub-menu items are readable in the overlay. */
