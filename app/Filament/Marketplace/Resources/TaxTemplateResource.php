...
class TaxTemplateResource extends Resource
{
    ...
    protected static function getSampleVariables(): array
    {
        ...
        return [
            ...
            'organizer_vat_status' => 'plătitor TVA bilete (cota 21%)',
            ...
            'event_has_monument_tax' => 'Nu',
            'event_manifestation_type' => 'Manifestare Muzicală',
            ...
            'ticket_types_rows' =>
                '<tr><td class="left-align">General Admission</td><td>500</td><td>150.00</td><td>75,000.00</td><td><span class="underline-blue">GA&nbsp;&nbsp;001 &gt; 500</span></td></tr>'
                . '<tr><td class="left-align">VIP</td><td>100</td><td>350.00</td><td>35,000.00</td><td><span class="underline-blue">VIP&nbsp;&nbsp;001 &gt; 100</span></td></tr>'
                . '<tr><td class="left-align">VIP - RED</td><td>100</td><td>315.00</td><td>31,500.00</td><td><span class="underline-blue">VIP-RED&nbsp;&nbsp;001 &gt; 100</span></td></tr>'
                . '<tr><td class="left-align">VIP - EARLY25</td><td>100</td><td>262.50</td><td>26,250.00</td><td><span class="underline-blue">VIP-EARLY25&nbsp;&nbsp;001 &gt; 100</span></td></tr>',
            'ticket_types_total_row' => '<tr class="total-row"><td><span class="bold">TOTAL</span></td><td>800</td><td>X</td><td>167,750.00</td><td>X</td></tr>',
            'total_tickets_for_sale' => '800',
            'total_value_for_sale' => '167,750.00',
            'total_subscriptions_for_sale' => '500',
            'total_subscriptions_value_for_sale' => '75,000.00',
            'total_non_subscription_tickets_for_sale' => '300',
            'total_non_subscription_value_for_sale' => '92,750.00',
