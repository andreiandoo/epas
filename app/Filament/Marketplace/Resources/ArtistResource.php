            ...
            SC\Grid::make(4)->schema([
                    ...
                    SC\Section::make('Videoclipuri YouTube')
                        ...
                        ->schema([
                            Forms\Components\Repeater::make('youtube_videos')
                                ...
                                ->reorderable()           // Activează drag & drop
                                ->reorderableWithButtons() // Opțional: butoane up/down în plus
                                ->reorderableWithDragAndDrop() // Drag handle vizibil
                                ->deletable()             // Activează butonul de delete
                                ->addable()
                                ->itemLabel(fn (array $state): ?string => $state['url'] ?? 'Video nou')
                                ->collapsible()           // Fiecare item poate fi collapsed
                                ->cloneable(false)        // Dezactivează clone
                                ->columnSpanFull(),
                            ]),
                ...
                SC\Group::make()->columnSpan(1)->schema([
                    ...
                    SC\Section::make('Status')
                        ...
                        ->compact()
                        ->schema([
                            Forms\Components\Toggle::make('is_active')->label('Activ'),
