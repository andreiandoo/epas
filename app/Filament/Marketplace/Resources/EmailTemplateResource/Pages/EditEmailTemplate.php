            ...
            Actions\Action::make('send_test')
                ...
                ->action(function (array $data) {
                    ...
                    $sampleVars = [
                        ...
                        'venue_location' => 'Sala Palatului, București',
                        'venue_address' => 'Str. Ion Câmpineanu 28, București',
                        'ticket_count' => '2',
                        'tickets_count' => '2',
                        'total_amount' => '150.00 RON',
                        'download_url' => rtrim($marketplace->domain ?? 'https://example.com', '/') . '/multumim?order=TEST-00001',
                        'tickets_list' => '<div style="padding:12px;background:#f9fafb;border-radius:8px;margin:8px 0;"><strong>Bilet Standard</strong> — Concert Test</div>',
                        ...
                        'login_url' => rtrim($marketplace->domain ?? 'https://example.com', '/') . '/login',
                        'reset_url' => rtrim($marketplace->domain ?? 'https://example.com', '/') . '/reset-password?token=test',
