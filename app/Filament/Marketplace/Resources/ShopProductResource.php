...
use App\Filament\Marketplace\Resources\ShopProductResource\Pages;
use App\Filament\Marketplace\Resources\ShopProductResource\RelationManagers;
                                    ...
                                    ->schema([
                                        Forms\Components\CheckboxList::make('attributes')
                                            ...
                                            ->options(function () {
                                                $marketplace = static::getMarketplaceClient();
                                                $lang = $marketplace->language ?? $marketplace->locale ?? 'en';
                                                return ShopAttribute::where('marketplace_client_id', $marketplace?->id)
                                                    ->get()
                                    ...
                                    ->schema([
                                        Forms\Components\Select::make('related_product_ids')
                                            ...
                                            ->options(function ($record) {
                                                $marketplace = static::getMarketplaceClient();
                                                $lang = $marketplace->language ?? $marketplace->locale ?? 'en';
                                                return ShopProduct::where('marketplace_client_id', $marketplace?->id)
