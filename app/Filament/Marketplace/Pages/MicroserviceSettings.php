                    ...
                    Forms\Components\Placeholder::make('stripe_redirect')
                        ->content(new HtmlString('
                            <div class="py-4 text-center">
                                ...
                                <a href="' . route('filament.marketplace.pages.payment-config') . '"
                    ...
                    Forms\Components\Placeholder::make('shop_links')
                        ->content(new HtmlString('
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                <a href="' . route('filament.marketplace.resources.shop-products.index') . '"
                                ...
                                <a href="' . route('filament.marketplace.resources.shop-categories.index') . '"
                                   class="flex items-center p-4 bg-white border rounded-lg shadow-sm hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                    <svg class="w-8 h-8 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="' . route('filament.marketplace.resources.shop-orders.index') . '"
                                   class="flex items-center p-4 bg-white border rounded-lg shadow-sm hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                    <svg class="w-8 h-8 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
