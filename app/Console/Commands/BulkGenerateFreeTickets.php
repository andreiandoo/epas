        ...
        foreach (array_chunk($allTicketIds, 50) as $chunkIds) {
            ...
            foreach ($tickets as $ticket) {
                ...
                try {
                    ...
                    // Multi-page verso (opt-in via template_data.page_2.enabled).
                    // Cand e activ, adaugam pagina 2 la fiecare bilet.
                    $page2Section = '';
                    ...
                    if ($page2Section !== '') {
                        // Multi-page: body fara height fix, prima pagina intr-un div, apoi verso.
