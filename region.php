...
<main class="px-4 py-12 mx-auto max-w-7xl">
    ...
    <section class="mb-12">
        <div class="flex items-center justify-between mb-6">
            ...
            <button onclick="RegionPage.showAllCities()" id="showAllCitiesBtn" class="flex items-center gap-1 text-sm font-semibold text-primary" name="showAllCitiesButton">
...
const RegionPage = {
    ...
    async loadEvents() {
        try {
            ...
            allEvents.sort((a, b) => {
                const dateA = new Date(a.starts_at || a.event_date || 0);
                const dateB = new Date(b.starts_at || b.event_date || 0);
                return dateA - dateB;
            });

            this.renderEvents(allEvents.slice(0, 3));
        } catch (e) {
