                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                        <div class="flex items-center gap-4">
                            @if($service->icon_image)
                                <img src="{{ Storage::url($service->icon_image) }}" alt="{{ $service->name }}" class="w-12 h-12 rounded-lg object-cover">
                            @else
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ $service->short_description }}</p>
                            </div>
                        </div>
