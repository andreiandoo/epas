                            ...
                            <table class="min-w-full text-sm divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    @foreach($ticketsList as $tkt)
                                        <tr class="cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800/50" onclick="window.location='{{ route('filament.admin.resources.tickets.view', ['record' => $tkt->id]) }}'">
                                            <td class="px-3 py-2 font-mono text-xs">
                                                <a href="{{ route('filament.admin.resources.tickets.view', ['record' => $tkt->id]) }}" class="text-primary-600 hover:underline">{{ $tkt->code ?? '-' }}</a>
                                            </td>
