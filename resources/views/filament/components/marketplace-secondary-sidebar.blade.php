...
>
    {{-- Header (dynamic title set by JS) --}}
    <div class="ep-secondary-sidebar-header">
        <div class="flex items-center gap-2">
            ...
            <span id="ep-secondary-sidebar-title" class="text-sm font-semibold text-gray-700 dark:text-gray-200">Microservices</span>
        </div>
        <button
    ...
    <nav class="ep-secondary-sidebar-nav">
        ...
        {{-- ===== PANEL: Microservices ===== --}}
        <div class="ep-secondary-sidebar-panel" data-ep-panel="microservices">
            {{-- Cloned Services items --}}
        ...
        <div class="ep-secondary-sidebar-panel" data-ep-panel="communications" style="display: none;">
            <div class="ep-secondary-sidebar-section">
                <ul id="ep-secondary-sidebar-communications-clone"></ul>
            </div>
        </div>

        {{-- ===== PANEL: Gamification ===== --}}
        <div class="ep-secondary-sidebar-panel" data-ep-panel="gamification" style="display: none;">
            <div class="ep-secondary-sidebar-section">
                <ul id="ep-secondary-sidebar-gamification-clone"></ul>
            </div>
        </div>
