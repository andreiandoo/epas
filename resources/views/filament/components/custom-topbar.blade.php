            ...
            @if(filament()->auth()->check())
                <div x-data="{
                    ...
                    >
                        ...
                        {{-- Profile --}}
                        <div class="fi-dropdown-list border-b border-gray-200 dark:border-gray-700">
                            <a href="{{ filament()->getProfileUrl() }}" class="flex items-center w-full gap-3 px-4 py-2 text-sm text-left text-gray-700 fi-dropdown-list-item dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
