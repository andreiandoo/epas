...
<body>
    <div class="ticket-container">
        ...
        <div class="qr-section">
            <img src="{{ $qrCodeDataUri ?? 'https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=' . urlencode($ticket->getVerifyUrl()) . '&color=181622&margin=0' }}" alt="QR Code" class="qr-code">
