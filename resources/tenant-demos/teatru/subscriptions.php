...
$plans = [
    ['name'=>'Clasic','code'=>'clasic','price'=>350,'sub'=>'5 spectacole • Staluri','featured'=>false,'features'=>['5 spectacole la alegere','Locuri în Staluri','Economie ~15%','Valabil toată stagiunea']],
    ['name'=>'Premium','code'=>'premium','price'=>600,'sub'=>'10 spectacole • Balcon','featured'=>true,'features'=>['10 spectacole la alegere','Locuri premium în Balcon','Economie ~30%','Acces prioritar la premiere','Program de fidelitate']],
    ['name'=>'Familie','code'=>'familie','price'=>1200,'sub'=>'4 persoane • 5 spectacole','featured'=>false,'features'=>['4 bilete per spectacol','5 spectacole la alegere','Locuri alăturate garantate','Economie ~25%','Ateliere pentru copii']],
];
?>
...
<section class="py-16 px-4 lg:px-8">
    <div class="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="subscription-card <?= $p['featured'] ? 'featured' : '' ?> rounded-2xl p-8 relative">
            ...
            <div class="mb-6"><p class="font-display text-5xl text-gold"><?= $p['price'] ?> <span class="text-xl">RON</span></p><p class="text-warm-gray text-sm"><?= e($p['sub']) ?></p></div>
