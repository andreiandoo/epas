...
<script>tailwind.config={theme:{extend:{fontFamily:{display:['Playfair Display','serif'],body:['DM Sans','sans-serif']},colors:{ink:'#090807',coal:'#151311',panel:'#1D1A17',wine:'#6F1D2C','wine-dark':'#49111C',brass:'#C9A75D','brass-light':'#E3C77D',paper:'#F4EFE6',muted:'#A9A096',drama:'#8B2234',revue:'#B77B24',imaginario:'#467A74'}}}};</script>
<style>
