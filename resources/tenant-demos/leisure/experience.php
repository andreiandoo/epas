...
<body x-data="experienceDetail()" x-init="init()" class="antialiased">
    ...
    <!-- Header -->
    <header class="safe-top fixed inset-x-0 top-0 z-[120] px-3 sm:px-5 lg:px-7">
        <nav class="nav-shell mx-auto flex max-w-[1540px] items-center justify-between gap-2 rounded-[18px] px-3 py-2.5 text-white transition-all duration-300 sm:rounded-[22px] sm:px-4 lg:px-5" :class="scrolled ? 'translate-y-0 shadow-lift' : 'translate-y-1.5'">
            ...
            <div class="hidden items-center gap-7 xl:flex">
                <a href="/experiente" class="text-sm font-semibold text-acid">Experiențe</a>
                <a href="#poveste" class="text-sm font-semibold text-white/70 transition hover:text-acid">Despre traseu</a>
                <a href="#ruta" class="text-sm font-semibold text-white/70 transition hover:text-acid">Ruta</a>
                <a href="#siguranta" class="text-sm font-semibold text-white/70 transition hover:text-acid">Siguranță</a>
                <a href="#faq" class="text-sm font-semibold text-white/70 transition hover:text-acid">Întrebări</a>
            </div>

            <div class="flex flex-none items-center gap-1.5 sm:gap-2">
                <a href="#" class="hidden whitespace-nowrap rounded-full border border-white/[.15] px-4 py-2.5 text-sm font-semibold text-white/[.82] transition hover:bg-white/10 lg:inline-flex">Contul meu</a>
                <button @click="openBooking()" class="inline-flex flex-none items-center justify-center gap-1.5 whitespace-nowrap rounded-full bg-acid px-3 py-2.5 text-[12px] font-bold text-pine-950 shadow-acid transition hover:-translate-y-0.5 sm:gap-2 sm:px-4 sm:text-sm lg:px-5">
    ...
    <!-- Mobile menu -->
    <div x-cloak x-show="menuOpen" class="fixed inset-0 z-[140]" role="dialog" aria-modal="true">
        ...
        <aside x-show="menuOpen" x-transition:enter="transition duration-500 ease-out" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition duration-350 ease-in" x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full" class="safe-bottom absolute right-0 top-0 flex h-full w-[min(88vw,430px)] flex-col bg-cream p-5 sm:p-7">
            ...
            <div class="mt-auto rounded-[22px] bg-pine-900 p-5 text-white">
                <div class="flex items-center gap-2 text-xs font-bold uppercase tracking-[.18em] text-acid"><span class="pulse-dot h-2 w-2 rounded-full bg-acid"></span> Disponibil astăzi</div>
                <p class="mt-3 text-sm text-white/[.65]">Următorul start · 14:00</p>
                <button @click="menuOpen = false; openBooking()" class="mt-5 w-full rounded-full bg-acid px-5 py-3.5 font-bold text-pine-950">Rezervă Canopy Run</button>
            </div>
        </aside>
    </div>
    ...
    <!-- Footer -->
    <footer class="bg-pine-950 px-4 pb-28 pt-14 text-white sm:px-6 lg:px-8 lg:pb-10">
        <div class="mx-auto max-w-[1420px]">
            <div class="grid gap-10 border-b border-white/10 pb-10 md:grid-cols-2 lg:grid-cols-[1.2fr_.8fr_.8fr_.8fr]">
                <div>
                    <div class="flex items-center gap-3"><span class="grid h-11 w-11 place-items-center rounded-full bg-pine-800"><svg viewBox="0 0 48 48" class="h-8 w-8" fill="none"><path d="M7 35 18 11l7 14 5-10 11 20H7Z" fill="#DFFC62"/><path d="m8 37 11-10 6 6 7-8 8 12H8Z" fill="#FFFDF6"/></svg></span><div><strong class="block font-display text-2xl">Nordvale</strong><span class="text-[8px] font-bold uppercase tracking-[.24em] text-white/40">wild park · forest reserve</span></div></div>
                    <p class="mt-5 max-w-sm text-sm leading-7 text-white/48">Un tenant Tixello demonstrativ pentru parcuri de aventură, rezervații și destinații leisure.</p>
                </div>
                <div><strong class="text-xs uppercase tracking-[.18em] text-acid">Explorează</strong><div class="mt-4 space-y-3 text-sm text-white/55"><a href="/experiente" class="block hover:text-white">Experiențe</a><a href="#ruta" class="block hover:text-white">Ruta Canopy Run</a><a href="#siguranta" class="block hover:text-white">Siguranță</a></div></div>
                <div><strong class="text-xs uppercase tracking-[.18em] text-acid">Vizită</strong><div class="mt-4 space-y-3 text-sm text-white/55"><a href="#" class="block hover:text-white">Program</a><a href="#" class="block hover:text-white">Acces și parcare</a><a href="#" class="block hover:text-white">Grupuri</a></div></div>
                <div><strong class="text-xs uppercase tracking-[.18em] text-acid">Suport</strong><div class="mt-4 space-y-3 text-sm text-white/55"><a href="#" class="block hover:text-white">Contact</a><a href="#" class="block hover:text-white">Termeni</a><a href="#" class="block hover:text-white">Confidențialitate</a></div></div>
            </div>
            <div class="flex flex-col gap-3 pt-6 text-xs text-white/36 sm:flex-row sm:items-center sm:justify-between"><span>© 2026 Nordvale. Concept demonstrativ.</span><span>Ticketing by <strong class="text-acid">Tixello</strong></span></div>
        </div>
    </footer>
