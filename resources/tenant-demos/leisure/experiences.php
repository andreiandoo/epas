    ...
    <header class="safe-top fixed inset-x-0 top-0 z-[100] px-2.5 sm:px-4 lg:px-6">
        <nav class="mx-auto mt-2 flex min-h-[62px] max-w-[1540px] items-center justify-between gap-2 rounded-[20px] px-3 py-2.5 transition-all duration-500 sm:gap-4 sm:px-4 lg:mt-4 lg:px-5"
            ...
            <div class="hidden items-center gap-7 xl:flex">
                <a href="#catalog" class="text-sm font-semibold text-acid">Experiențe</a>
                <a href="#finder" class="text-sm font-semibold text-white/70 transition hover:text-acid">Găsește aventura</a>
                <a href="#categorii" class="text-sm font-semibold text-white/70 transition hover:text-acid">Categorii</a>
                <a href="#ghid" class="text-sm font-semibold text-white/70 transition hover:text-acid">Cum alegi</a>
    ...
    <footer class="bg-pine-950 px-4 pb-8 pt-16 text-white sm:px-6 sm:pt-20 lg:px-10">
        <div class="mx-auto max-w-[1460px]">
            <div class="grid gap-12 border-b border-white/10 pb-14 lg:grid-cols-[1.25fr_.75fr_.75fr_.75fr]">
                <div>
                    <div class="font-display text-4xl font-semibold">Nordvale</div>
                    <p class="mt-4 max-w-sm text-sm leading-7 text-white/[.48]">Parc de aventură și rezervație forestieră. Concept demonstrativ pentru un tenant Tixello leisure.</p>
                    <div class="mt-6 flex gap-2"><a href="#" class="grid h-10 w-10 place-items-center rounded-full border border-white/[.12] text-xs">IG</a><a href="#" class="grid h-10 w-10 place-items-center rounded-full border border-white/[.12] text-xs">FB</a><a href="#" class="grid h-10 w-10 place-items-center rounded-full border border-white/[.12] text-xs">YT</a></div>
                </div>
                <div><div class="text-[10px] font-bold uppercase tracking-[.2em] text-acid">Explorează</div><div class="mt-5 space-y-3 text-sm text-white/[.58]"><a href="#catalog" class="block hover:text-white">Experiențe</a><a href="#finder" class="block hover:text-white">Adventure Finder</a><a href="#categorii" class="block hover:text-white">Categorii</a><a href="#ghid" class="block hover:text-white">Ghid de alegere</a></div></div>
                <div><div class="text-[10px] font-bold uppercase tracking-[.2em] text-acid">Vizită</div><div class="mt-5 space-y-3 text-sm text-white/[.58]"><a href="#" class="block hover:text-white">Planifică vizita</a><a href="#" class="block hover:text-white">Acces și parcare</a><a href="#" class="block hover:text-white">Grupuri</a><a href="#" class="block hover:text-white">Contact</a></div></div>
            ...
            <div class="flex flex-col gap-4 py-6 text-xs text-white/[.38] sm:flex-row sm:items-center sm:justify-between"><p>© 2026 Nordvale. Date demonstrative.</p><div class="flex flex-wrap gap-5"><a href="#">Termeni</a><a href="#">Confidențialitate</a><span>Ticketing by <strong class="text-acid">tixello</strong></span></div></div>
        </div>
    </footer>
