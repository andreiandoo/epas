...
<main class="max-w-6xl px-6 py-10 mx-auto">
    ...
    <section class="mb-16">
        ...
        <div id="citiesGrid" class="grid grid-cols-4 gap-5 mobile:grid-cols-2">
            <!-- Generated by JS -->
        </div>
...
const CitiesPage = {
    ...
    renderCities(append = false) {
        ...
        const html = this.cities.map(city => {
            ...
            return `
                <a href="${cityUrl}" class="flex items-center gap-4 p-4 bg-white rounded-2xl border border-border hover:border-primary hover:shadow-lg hover:-translate-y-0.5 transition-all mobile:p-2">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-sm text-muted mb-1.5 mobile:mb-0">${countyCode ? countyCode + ' • ' : ''}${region}</p>
