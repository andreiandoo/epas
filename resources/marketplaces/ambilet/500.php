    ...
    <div class="flex items-center justify-center flex-1 p-8">
        <div class="max-w-xl text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4 mb-8">
                ...
                <button onclick="location.reload()" class="inline-flex items-center gap-2 px-6 py-3 font-semibold text-white transition-colors border rounded-xl bg-white/10 border-white/20 hover:bg-white/20" aria-label="Incearca din nou">
