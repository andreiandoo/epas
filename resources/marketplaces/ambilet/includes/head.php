...
<head>
    ...
    <!-- Full CSS (non-render-blocking: critical CSS is already inlined above) -->
    <link rel="preload" as="style" href="<?= asset('assets/css/styles.css') ?>">
    <link href="<?= asset('assets/css/styles.css') ?>" rel="stylesheet" media="print" onload="this.media='all'">
    <noscript><link href="<?= asset('assets/css/styles.css') ?>" rel="stylesheet"></noscript>
