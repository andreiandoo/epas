...
?>
            <!-- Mobile Menu Toggle -->
            <button id="mobile-sidebar-toggle" class="hidden sticky z-40 justify-center text-white mobile:flex items-center gap-x-2 shadow-lg lg:hidden right-0 left-0 mx-auto h-14 bg-primary rounded-full bottom-4" style="width: 90%;">
