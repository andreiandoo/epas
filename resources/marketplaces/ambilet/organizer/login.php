            ...
            <div class="w-full max-w-md">
                ...
                <form id="login-form" class="space-y-4">
                    <div>
                        ...
                        <input type="email" name="email" required placeholder="organizator@email.com" class="input" autocomplete="email" autocapitalize="none" autocorrect="off" spellcheck="false" inputmode="email">
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password" required placeholder="********" class="pr-12 input" id="password-input" autocomplete="current-password" autocapitalize="none" autocorrect="off" spellcheck="false">
