    ...
    <div class="flex flex-col flex-1 bg-surface">
        ...
        <div class="flex items-center justify-center flex-1 p-6 lg:p-12">
            <div class="w-full max-w-md">
                ...
                <div id="requestForm">
                    <a href="/organizator/login" class="inline-flex items-center gap-2 mb-8 text-sm text-muted hover:text-primary">
                    ...
                    <p class="mt-6 text-sm text-center text-muted">
                        ...
                        <a href="/organizator/login" class="font-semibold text-primary">Autentifică-te</a>
                    </p>
                </div>
...
SCRIPTS;
$scriptsExtra .= '<script defer src="' . asset('assets/js/pages/organizer-forgot-password.js') . '"></script>';
