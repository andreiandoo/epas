        ...
        <div id="step4" class="step-content hidden">
            <div class="bg-white rounded-2xl border border-border p-8">
                ...
                <div class="space-y-3 mb-6">
                    <label class="flex items-start gap-3 cursor-pointer"><input type="checkbox" name="terms" required class="mt-1 w-4 h-4 rounded border-border text-primary focus:ring-primary"><span class="text-sm text-muted">Accept <a href="/terms.php" class="text-primary hover:underline">Termenii si Conditiile</a> pentru organizatori si <a href="/privacy.php" class="text-primary hover:underline">Politica de Confidentialitate</a> *</span></label>
                    <label class="flex items-start gap-3 cursor-pointer"><input type="checkbox" name="contract" required class="mt-1 w-4 h-4 rounded border-border text-primary focus:ring-primary"><span class="text-sm text-muted">Accept <a href="/contract.php" class="text-primary hover:underline">Contractul de prestari servicii</a> <?= SITE_NAME ?> *</span></label>
                </div>
