...
?>
    ...
    <div class="flex flex-col flex-1 min-h-screen lg:ml-0">
        ...
        <main class="flex-1">
            <!-- Welcome Banner -->
            <div class="relative p-6 overflow-hidden text-white bg-gradient-to-r from-primary to-primary-dark">
                ...
                <div class="relative">
                    ...
                    <p id="welcome-stat" class="text-white/80">Ai vandut 0 bilete in ultima saptamana. Continua tot asa!</p>
                </div>
            </div>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="p-5 bg-white border rounded-2xl border-border">
                            ...
                            <div class="flex flex-col items-center gap-4">
                                <img src="https://api.qrserver.com/v1/create-qr-code/?data=https%3A%2F%2Fambilet.ro%2Fandroid&size=160x160&margin=8" alt="QR Code - Descarcă aplicația" class="w-40 h-40 border rounded-lg border-border" loading="lazy">
