...
$categoryPhrase = match ($update['category']) {
    ...
    'aplicatie-mobila' => 'Noutate în Aplicația mobilă',
...
$categoryIcon = match ($update['category']) {
    ...
    'aplicatie-mobila' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a1 1 0 001-1V4a1 1 0 00-1-1H8a1 1 0 00-1 1v16a1 1 0 001 1z"/></svg>',
    default       => '',
};
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <?php foreach ($related as $r):
                $rPhrase = match ($r['category']) {
                    ...
                    'aplicatie-mobila' => 'Aplicația mobilă',
