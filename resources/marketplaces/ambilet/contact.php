...
<main class="px-6 py-12 mx-auto max-w-7xl">
    ...
    <div class="relative z-10 grid grid-cols-1 gap-5 mb-12 -mt-20 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <a href="tel:+40726131516" class="text-center transition-all bg-white border border-gray-200 shadow-lg rounded-2xl p-7 hover:-translate-y-1 hover:shadow-xl hover:border-primary group">
            <div class="w-14 h-14 bg-gradient-to-br from-primary to-primary-light rounded-[14px] flex items-center justify-center mx-auto mb-4 text-white">
                <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span class="text-sm font-semibold text-primary">+40 726 131 516</span>
        </a>
                ...
                <div class="space-y-0">
                    ...
                    <div class="flex items-start gap-3.5 py-3.5 border-b border-gray-100">
                        ...
                        <div>
                            ...
                            <a href="tel:+40726131516" class="text-[15px] font-semibold text-primary">+40 726 131 516</a>
                        </div>
                    </div>
