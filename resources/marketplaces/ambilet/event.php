...
<?php require_once __DIR__ . '/includes/header.php'; ?>
    ...
    <main class="px-4 py-8 mx-auto max-w-7xl mobile:p-0 mobile:mt-18" id="main-content">
        ...
        <div class="mt-8 space-y-8 mobile:mt-0 mobile:space-y-0">
            ...
            <!-- Artist Section -->
            <div id="artist-section" style="display:none;" class="mobile:p-0">
                <div id="artist-content" class="mobile:p-4"></div>
            </div>

            <!-- Venue Section -->
            <div id="venue" class="mobile:border-b mobile:border-border">
                <div id="venue-content" class="mobile:p-4"></div>
            </div>
        </div>

        <!-- Bottom button + slide-up drawer — visible on anything below lg (1024px) -->
        <div id="mobileTicketBtn" class="sticky bottom-0 left-0 right-0 z-[105] p-4 bg-primary border-none lg:hidden safe-area-bottom">
