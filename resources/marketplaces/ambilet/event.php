...
<?php require_once __DIR__ . '/includes/header.php'; ?>
    ...
    <main class="px-4 py-8 mx-auto max-w-7xl mobile:p-0 mobile:mt-18" id="main-content">
        ...
        <!-- Bottom button + slide-up drawer — visible on anything below
             lg (1024px). Covers true mobile, tablets in portrait, and
             desktop-mode-on-mobile (browsers force ~980px viewport when
             "Request desktop site" is on, which falls within this range). -->
        <div id="mobileTicketBtn" class="sticky bottom-0 left-0 right-0 z-[105] p-4 bg-primary border-t lg:hidden border-border border-b safe-area-bottom">
