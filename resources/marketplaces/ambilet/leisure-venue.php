...
// Pus aici (nu via $scriptsExtra) ca sa fim siguri ca nu e suprascris de
// alte include-uri sau ignorat dupa </body></html> emis de scripts.php.
...
?>
<script src="<?= ASSETS_URL ?>/js/pages/leisure-venue.js?v=<?= $leisureJsVer ?>"></script>
<?php
