...
<head>
    ...
    <title>Confirmare comanda #<?= $order_id ?? '' ?> - <?= $site_name ?? 'bilete.online' ?></title>
</head>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden;">
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 16px;">
                                        <span style="display: inline-block; background-color: rgba(255,255,255,0.2); border-radius: 50%; padding: 16px; font-size: 28px;">âœ“</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <h2 style="margin: 0 0 16px 0; color: #1E293B; font-size: 18px; font-weight: 700;">ðŸŽ« Biletele tale</h2>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td align="center" bgcolor="#A51C30" style="background-color: #A51C30; border-radius: 10px;">
                                                    <a href="<?= $tickets_download_link ?>" target="_blank" style="display: inline-block; padding: 14px 24px; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 14px;">ðŸ“¥ Descarca PDF</a>
                                                </td>
                                                ...
                                                <td align="center" style="background-color: #F8FAFC; border: 1px solid #E2E8F0; border-radius: 10px;">
                                                    <a href="<?= $add_to_calendar_link ?>" target="_blank" style="display: inline-block; padding: 14px 24px; color: #1E293B; text-decoration: none; font-weight: 600; font-size: 14px;">ðŸ“… Calendar</a>
                                                </td>
                                                <?php endif; ?>
                                            </tr>
                                        </table>
                            ...
                            <h2 style="margin: 0 0 16px 0; color: #1E293B; font-size: 18px; font-weight: 700;">ðŸ’³ Sumar comanda</h2>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #EFF6FF; border-radius: 12px;">
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="margin: 0 0 8px 0; color: #3B82F6; font-size: 14px;">â€¢ Prezinta codul QR direct de pe telefon sau tiparit</p>
                                        <p style="margin: 0 0 8px 0; color: #3B82F6; font-size: 14px;">â€¢ Vino cu 30 minute inainte de inceperea evenimentului</p>
                                        <p style="margin: 0; color: #3B82F6; font-size: 14px;">â€¢ Biletele sunt nominale si netransferabile</p>
                                    </td>
                                </tr>
                            </table>

                            <p style="margin: 24px 0 0 0; color: #64748B; font-size: 14px; line-height: 1.6;">
                                Ai intrebari? <a href="mailto:<?= $support_email ?? 'suport@bilete.online' ?>" style="color: #A51C30; text-decoration: none;"><?= $support_email ?? 'suport@bilete.online' ?></a>
                            </p>
                    ...
                    <tr>
                        <td bgcolor="#F8FAFC" style="background-color: #F8FAFC; padding: 30px; border-top: 1px solid #E2E8F0;">
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td align="center" style="padding-bottom: 16px;">
                                        <span style="color: #1E293B; font-size: 18px; font-weight: 800;"><?= strtoupper($site_name ?? 'BILETE.ONLINE') ?></span>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin: 16px 0 0 0; color: #94A3B8; font-size: 13px; text-align: center;">
                                <a href="<?= $site_url ?? 'https://bilete.online' ?>/privacy" style="color: #94A3B8; text-decoration: underline;">Confidentialitate</a>
                            </p>
                        </td>
                    </tr>
