...
<head>
    ...
    <title>Biletul tau pentru <?= $event_name ?? '' ?> - <?= $site_name ?? 'bilete.online' ?></title>
</head>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden;">
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 16px;">
                                        <span style="display: inline-block; background-color: rgba(255,255,255,0.2); border-radius: 50%; padding: 16px; font-size: 32px;">ðŸŽ«</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                                ...
                                <tr>
                                    <td style="padding: 24px;">
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td style="padding: 8px 0; vertical-align: top; width: 32px; font-size: 18px;">ðŸ“…</td>
                            ...
                            <h2 style="margin: 0 0 16px 0; color: #1E293B; font-size: 18px; font-weight: 700;">ðŸŽ« Biletul tau</h2>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                ...
                                                <td align="center" bgcolor="#A51C30" style="background-color: #A51C30; border-radius: 10px;">
                                                    <a href="<?= $ticket_download_link ?>" target="_blank" style="display: inline-block; padding: 14px 28px; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 14px;">ðŸ“¥ Descarca biletul PDF</a>
                                                </td>
                                                <?php endif; ?>
                                                ...
                                                <td align="center" style="background-color: #F8FAFC; border: 1px solid #E2E8F0; border-radius: 10px;">
                                                    <a href="<?= $add_to_calendar_link ?>" target="_blank" style="display: inline-block; padding: 14px 28px; color: #1E293B; text-decoration: none; font-weight: 600; font-size: 14px;">ðŸ“… Adauga in calendar</a>
                                                </td>
                                                <?php endif; ?>
                                            </tr>
                                        </table>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #EFF6FF; border-radius: 12px; margin-top: 16px;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <p style="margin: 0 0 12px 0; color: #1E40AF; font-weight: 700; font-size: 14px;">ðŸ“‹ Important de stiut</p>
                                        <p style="margin: 0 0 8px 0; color: #3B82F6; font-size: 14px;">â€¢ Prezinta codul QR din acest email sau din PDF</p>
                                        <p style="margin: 0 0 8px 0; color: #3B82F6; font-size: 14px;">â€¢ Vino cu 30 minute inainte de inceperea evenimentului</p>
                                        <p style="margin: 0; color: #3B82F6; font-size: 14px;">â€¢ Ai nevoie de un act de identitate valid</p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #FEF3C7; border-radius: 12px; margin-top: 16px;">
                                <tr>
                                    <td align="center" style="padding: 20px;">
                                        ...
                                        <p style="margin: 8px 0 4px 0; color: #92400E; font-weight: 700; font-size: 16px;">Creaza-ti cont pe <?= $site_name ?? 'bilete.online' ?>!</p>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td align="center" style="background-color: #ffffff; border: 1px solid #FCD34D; border-radius: 10px;">
                                                    <a href="<?= $site_url ?? 'https://bilete.online' ?>/register" target="_blank" style="display: inline-block; padding: 10px 20px; color: #92400E; text-decoration: none; font-weight: 600; font-size: 13px;">Creaza cont gratuit</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <p style="margin: 24px 0 0 0; color: #64748B; font-size: 14px; line-height: 1.6;">
                                Ai intrebari? Contacteaza-ne la <a href="mailto:<?= $support_email ?? 'suport@bilete.online' ?>" style="color: #A51C30; text-decoration: none;"><?= $support_email ?? 'suport@bilete.online' ?></a>
                            </p>
