...
<head>
    ...
    <title>Bine ai venit in comunitatea de organizatori <?= $site_name ?? 'bilete.online' ?>!</title>
</head>
<body style="margin: 0; padding: 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #F8FAFC; -webkit-font-smoothing: antialiased;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden;">Contul tau de organizator pe <?= $site_name ?? 'bilete.online' ?> este acum activ. Incepe sa vinzi bilete!</div>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 24px 0; color: #64748B; font-size: 16px; line-height: 1.6;">Suntem incantati sa avem <strong><?= $company_name ?? 'compania ta' ?></strong> in comunitatea de organizatori <?= $site_name ?? 'bilete.online' ?>! Esti pregatit sa organizezi evenimente memorabile?</p>
                                                    ...
                                                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td style="padding-left: 12px;">
                                                                ...
                                                                <p style="margin: 4px 0 0 0; color: #64748B; font-size: 13px;">Evenimentul tau va fi vizibil pe <?= $site_name ?? 'bilete.online' ?>.</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td align="center" bgcolor="#A51C30" style="background-color: #A51C30; border-radius: 12px;">
                                                    <a href="<?= $site_url ?? 'https://bilete.online' ?>/organizer/dashboard" target="_blank" style="display: inline-block; padding: 16px 32px; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 16px;">Acceseaza dashboard-ul</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <h2 style="margin: 24px 0 16px 0; color: #1E293B; font-size: 18px; font-weight: 700;">De ce <?= $site_name ?? 'bilete.online' ?>?</h2>
