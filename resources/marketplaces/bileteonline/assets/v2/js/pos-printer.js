...
(function (global) {
     ...
     *   [@ POS / cashier]                            — normal
     *   ──────────────────
     *   [Ticketing prin bilete.online]                  — small
    ...
    function buildTicketCommands(ticket) {
        ...
        parts.push(SIZE_SMALL, lineOf('Ticketing prin bilete.online'), SIZE_NORMAL);
        parts.push(lineOf('--------------------------------'));
        ...
        //
        // Pentru un payload tipic "codul biletului" (~32 chars):
        ...
        if (t.qr_data) {
            // bilete.online: QR-ul poarta exact codul biletului, asa cum il citeste
            // aplicatia de scanare. Nu il impachetam intr-un link.
            let qrPayload = t.qr_data;
            parts.push(FEED_N(1));
        ...
        // POS / cashier pe ultima linie (numele locatiei e deja în header). Bixolon are
