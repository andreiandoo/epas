...
const BileteOnlineDataTransformer = {
    ...
    normalizeEvent(apiEvent) {
        ...
        return {
            ...
            priceFormatted: (apiEvent.is_password_protected)
                ...
                : minPrice > 0 ? (hasMultipleTicketTypes ? '<span class="font-semibold text-slate-700 text-xs">De la </span>' : '<span class="font-semibold text-slate-800 text-xs">Bilete: </span>') + BileteOnlineUtils.formatCurrency(minPrice) : 'Gratuit',
     ...
     * E.g. "2026-02-28T20:00:00.000000Z" â†’ "20:00"
     */
...
window.BileteOnlineDataTransformer = BileteOnlineDataTransformer;
