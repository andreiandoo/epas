...
const BileteOnlinePagination = {
    ...
    setLoadingState(isLoading, labels = {}) {
        ...
        const loadingLabel = labels.loading || 'Se Ã®ncarcÄƒ...';
        const loadMoreLabel = labels.loadMore || 'ÃŽncarcÄƒ mai multe';
    ...
    renderInfo(options = {}) {
        ...
        return 'AfiÈ™are ' + start + '-' + end + ' din ' + total + ' rezultate';
    },
...
window.BileteOnlinePagination = BileteOnlinePagination;
