                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
                    ...
                    <div class="col-span-2 lg:col-span-1">
                        ...
                        <p class="text-white/90 text-sm mb-6">
                            PlatformÄƒ de ticketing pentru evenimente din RomÃ¢nia. Bilete pentru concerte, festivaluri, teatru È™i multe altele.
                        </p>
                        <div class="flex gap-4">
                            <a href="${BILETEONLINE_CONFIG.SOCIAL.FACEBOOK}" target="_blank" rel="noopener" aria-label="Facebook" class="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center hover:bg-primary transition-colors">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                </svg>
                            </a>
                            <a href="${BILETEONLINE_CONFIG.SOCIAL.INSTAGRAM}" target="_blank" rel="noopener" aria-label="Instagram" class="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center hover:bg-primary transition-colors">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="${BILETEONLINE_CONFIG.SOCIAL.TWITTER}" target="_blank" rel="noopener" aria-label="X (Twitter)" class="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center hover:bg-primary transition-colors">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            ...
                            <li><a href="/register.php" class="text-white/90 hover:text-white text-sm transition-colors">ÃŽnregistrare</a></li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="/parteneri" class="text-white/90 hover:text-white text-sm transition-colors">Vinde bilete</a></li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="/user/help.php" class="text-white/90 hover:text-white text-sm transition-colors">ÃŽntrebÄƒri frecvente</a></li>
                            <li><a href="/contact.php" class="text-white/90 hover:text-white text-sm transition-colors">Contact</a></li>
                            <li><a href="/terms.php" class="text-white/90 hover:text-white text-sm transition-colors">Termeni È™i condiÈ›ii</a></li>
                            <li><a href="/privacy.php" class="text-white/90 hover:text-white text-sm transition-colors">Politica de confidenÈ›ialitate</a></li>
                ...
                <div class="mt-12 pt-8 border-t border-white/10">
                    <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
                        <div class="flex items-center gap-4">
                            <span class="text-white/90 text-sm">PlÄƒÈ›i securizate:</span>
                ...
                <div class="mt-8 pt-8 border-t border-white/10">
                    <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                        <p class="text-white/90 text-sm">
                            &copy; ${currentYear} bilete.online. Toate drepturile rezervate.
                        </p>
                        <p class="text-white/90 text-sm">
