...
const BileteOnlineNotifications = {
    container: null,
    queue: [],
    isProcessing: false,
     ...
     */
    bindEvents() {
        window.addEventListener('bileteonline:notification', (e) => {
...
document.addEventListener('DOMContentLoaded', () => {
    BileteOnlineNotifications.init();
});

// Global shorthand
window.toast = {
    success: (msg, dur) => BileteOnlineNotifications.success(msg, dur),
    error: (msg, dur) => BileteOnlineNotifications.error(msg, dur),
    warning: (msg, dur) => BileteOnlineNotifications.warning(msg, dur),
    info: (msg, dur) => BileteOnlineNotifications.info(msg, dur)
};
