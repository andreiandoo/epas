...
const BileteOnlineEmptyState = {
    ...
    MESSAGES: {
        'no-results': {
            icon: 'search',
            title: 'Nu am gÄƒsit rezultate',
            text: 'ÃŽncearcÄƒ sÄƒ modifici filtrele sau sÄƒ cauÈ›i altceva.',
            buttonText: 'ReseteazÄƒ filtrele'
        },
        'no-events': {
            icon: 'sad',
            title: 'Nu am gÄƒsit evenimente',
            text: 'ÃŽncearcÄƒ sÄƒ modifici filtrele sau verificÄƒ mai tÃ¢rziu.',
            buttonText: 'ReseteazÄƒ filtrele'
        },
        'not-found': {
            icon: 'notFound',
            title: 'Pagina nu a fost gÄƒsitÄƒ',
            text: 'Ne pare rÄƒu, dar aceastÄƒ paginÄƒ nu existÄƒ sau a fost mutatÄƒ.',
            buttonText: 'ÃŽnapoi la pagina principalÄƒ',
            buttonUrl: '/'
        },
        'error': {
            icon: 'error',
            title: 'A apÄƒrut o eroare',
            text: 'Nu am putut Ã®ncÄƒrca datele. Te rugÄƒm sÄƒ Ã®ncerci din nou.',
            buttonText: 'ReÃ®ncearcÄƒ'
        },
        'empty': {
            icon: 'empty',
            title: 'Nu existÄƒ date',
            text: 'Momentan nu existÄƒ elemente de afiÈ™at.',
            buttonText: null
        },
        'coming-soon': {
            icon: 'clock',
            title: 'ÃŽn curÃ¢nd',
            text: 'AceastÄƒ secÈ›iune va fi disponibilÄƒ Ã®n curÃ¢nd.',
            buttonText: null
        },
        'no-venue': {
            icon: 'location',
            title: 'LocaÈ›ia nu a fost gÄƒsitÄƒ',
            text: 'Ne pare rÄƒu, dar aceastÄƒ locaÈ›ie nu existÄƒ sau a fost È™tearsÄƒ.',
            buttonText: 'Vezi toate locaÈ›iile',
            buttonUrl: '/locatii'
        },
        'no-artist': {
            icon: 'artist',
            title: 'Artistul nu a fost gÄƒsit',
            text: 'Ne pare rÄƒu, dar acest artist nu existÄƒ sau a fost È™ters.',
            buttonText: 'Vezi toÈ›i artiÈ™tii',
            buttonUrl: '/artisti'
        }
    },
...
window.BileteOnlineEmptyState = BileteOnlineEmptyState;
