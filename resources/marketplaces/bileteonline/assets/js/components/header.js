...
const BileteOnlineHeader = {
    ...
    init() {
        ...
        if (document.getElementById('cartDrawer') && document.getElementById('searchOverlay')) {
            console.log('[BileteOnlineHeader] PHP mega-header detected, skipping JS render');
            this.bindAuthEvents();
            return;
        }
    ...
    bindAuthEvents() {
        ...
        window.addEventListener('bileteonline:auth:login', () => this.updatePHPHeaderAuth());
        window.addEventListener('bileteonline:auth:logout', () => this.updatePHPHeaderAuth());
    ...
    bindDropdownDismiss() {
        ...
        document.addEventListener('bileteonline:menu:open', () => {
            dropdown.classList.remove('active');
        });
    },
     ...
     */
    updatePHPHeaderAuth() {
        const isLoggedIn = typeof BileteOnlineAuth !== 'undefined' && BileteOnlineAuth.isLoggedIn();
        const isOrganizer = typeof BileteOnlineAuth !== 'undefined' && BileteOnlineAuth.isOrganizer();
        ...
        if (isLoggedIn && userMenu) {
            const user = BileteOnlineAuth.getCurrentUser();
     ...
     */
    getTemplate() {
        const isLoggedIn = BileteOnlineAuth.isLoggedIn();
        const user = BileteOnlineAuth.getCurrentUser();
        const cartCount = BileteOnlineCart.getItemCount();
        const isOrganizer = BileteOnlineAuth.isOrganizer();
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                <div class="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <nav class="hidden lg:flex items-center gap-8">
                        <a href="/" class="text-sm font-medium text-secondary hover:text-primary transition-colors">AcasÄƒ</a>
            ...
            <div id="mobile-menu" class="mobile-menu fixed inset-y-0 right-0 w-80 max-w-full bg-white shadow-2xl lg:hidden z-50">
                <div class="flex flex-col h-full">
                    <div class="flex items-center justify-between p-4 border-b border-border">
                        ...
                        <button id="close-mobile-menu" aria-label="ÃŽnchide" class="p-2 hover:bg-surface rounded-xl">
                    ...
                    <div class="flex-1 overflow-y-auto p-4">
                        ...
                        <div class="relative mb-6">
                            <input type="text" placeholder="CautÄƒ evenimente..." class="w-full pl-10 pr-4 py-3 bg-surface rounded-xl text-sm">
                        ...
                        <!-- Mobile Nav Links -->
                        <nav class="space-y-2">
                            <a href="/" class="block px-4 py-3 text-secondary font-medium rounded-xl hover:bg-surface">AcasÄƒ</a>
                ...
                <div class="bg-white rounded-xl shadow-xl border border-border py-2">
                    ...
                    ${isOrganizer
                        ? `<a href="/organizator/panou" class="block px-4 py-2 text-sm text-secondary hover:bg-surface hover:text-primary transition-colors">Panoul meu</a>
                           ...
                           <a href="/organizator/sold" class="block px-4 py-2 text-sm text-secondary hover:bg-surface hover:text-primary transition-colors">Sold & PlÄƒÈ›i</a>
                           <a href="/organizator/setari" class="block px-4 py-2 text-sm text-secondary hover:bg-surface hover:text-primary transition-colors">SetÄƒri</a>`
                        : `<a href="/cont/dashboard" class="block px-4 py-2 text-sm text-secondary hover:bg-surface hover:text-primary transition-colors">Contul meu</a>
                           ...
                           <a href="/cont/setari" class="block px-4 py-2 text-sm text-secondary hover:bg-surface hover:text-primary transition-colors">SetÄƒri</a>`
                    }
    ...
    getAuthLinks() {
        ...
        <div class="hidden lg:flex items-center gap-3">
            ...
            <a href="/register" class="btn btn-primary bg-primary btn-sm">ÃŽnregistrare</a>
        </div>
        `;
    },
    ...
    bindEvents() {
        ...
        window.addEventListener('bileteonline:auth:login', () => this.updateUI());
        window.addEventListener('bileteonline:auth:logout', () => this.updateUI());

        // Listen for cart changes
        window.addEventListener('bileteonline:cart:update', () => this.updateCartBadge());
    },
     ...
     */
    updateCartBadge() {
        const count = BileteOnlineCart.getItemCount();
