 ...
 * Venues and organizers have their own flow under /organizator/forgot-password.
 *
...
<main id="main" tabindex="-1">
  <section class="af-hero" aria-labelledby="af-h">
    <svg class="deco-arches" viewBox="0 0 400 400" aria-hidden="true" focusable="false"><path d="M40 400V200a160 160 0 0 1 320 0v200"/><path d="M90 400V200a110 110 0 0 1 220 0v200"/><path d="M140 400V200a60 60 0 0 1 120 0v200"/></svg>    <div class="af-in">
      <div class="af-copy">
        <nav class="crumbs" aria-label="Breadcrumb"><a href="/">Acasă</a><span aria-hidden="true">/</span><a href="/autentificare">Autentificare</a><span aria-hidden="true">/</span><span aria-current="page">Parolă uitată</span></nav>
        <p class="af-kicker">Resetare parolă · client</p>
      ...
      <section class="af-card" id="af-card" aria-label="Trimite link de resetare">
        ...
        <div class="af-view" id="fp-form-view">
          ...
          <p class="af-card-p">Introdu emailul contului. Dacă există un cont asociat, vei primi un link de resetare în câteva minute.</p>
          <p class="af-error" id="fp-error" role="alert" hidden></p>
          <form class="af-form" id="fp-form" novalidate>
            <div class="af-field">
        ...
        <div class="af-view" id="fp-sent-view" hidden>
          ...
          <div class="af-actions is-2">
            ...
            <a class="btn btn-primary" id="fp-login" href="/autentificare">Înapoi la login</a>
          </div>
