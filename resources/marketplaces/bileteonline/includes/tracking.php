 ...
 * `bileteonline_active_organizer` cookie set on event pages) to route through
 * the organizer overlay endpoint. That endpoint returns organizer pixels
 * layered on top of the marketplace fallback per provider — an organizer that
 * only configured GA4 still inherits the marketplace's TikTok/Meta/Google Ads,
 * and conversely marketplace pixels don't double-fire on top of organizer
 * pixels of the same provider.
 *
