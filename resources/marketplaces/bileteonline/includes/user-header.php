...
<div id="mobileMenu" class="fixed inset-y-0 left-0 z-50 flex flex-col bg-white menu-mobile w-72 lg:hidden">
    <div class="flex items-center justify-between p-4 border-b border-border">
        <a href="/" class="flex items-center gap-2">
            <img src="/assets/images/bileteonline-logo.webp" alt="<?= SITE_NAME ?>" class="hidden w-auto h-9">
    ...
    <div class="p-4 border-t border-border">
        <a href="#" onclick="BileteOnlineAuth.logout(); return false;" class="flex items-center gap-3 px-4 py-3 font-medium text-error hover:bg-error/10 rounded-xl">
