...
function markBackendUnreachable(string $reason): void {
    $GLOBALS['bileteonline_backend_unreachable'] = true;
    $flagFile = sys_get_temp_dir() . '/bileteonline_backend_unreachable.flag';
...
function markBackendReachable(): void {
    $GLOBALS['bileteonline_backend_unreachable'] = false;
    $flagFile = sys_get_temp_dir() . '/bileteonline_backend_unreachable.flag';
    if (is_file($flagFile)) {
        @unlink($flagFile);
    }
...
function isBackendUnreachable(): bool {
    if (!empty($GLOBALS['bileteonline_backend_unreachable'])) {
        return true;
    }
    $flagFile = sys_get_temp_dir() . '/bileteonline_backend_unreachable.flag';
    if (!is_file($flagFile)) {
