...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 flex flex-col w-64 transform -translate-x-full bg-white border-r sidebar lg:static border-border lg:translate-x-0">
    ...
    <nav class="flex-1 space-y-1 overflow-y-auto">
        <a href="/organizator/panou" class="sidebar-link <?= $currentPage === 'dashboard' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 m-2 rounded-xl text-sm font-medium <?= $currentPage !== 'dashboard' ? 'text-muted' : '' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
            Dashboard
        </a>
        <a href="/organizator/events" class="sidebar-link <?= $currentPage === 'events' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 m-2 rounded-xl text-sm font-medium <?= $currentPage !== 'events' ? 'text-muted' : '' ?>">
        ...
        <a href="/organizator/participanti" class="sidebar-link <?= $currentPage === 'participants' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 m-2 rounded-xl text-sm font-medium <?= $currentPage !== 'participants' ? 'text-muted' : '' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
            Participanti
        </a>
        <a href="/organizator/vanzari" class="sidebar-link <?= $currentPage === 'sales' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 m-2 rounded-xl text-sm font-medium <?= $currentPage !== 'sales' ? 'text-muted' : '' ?>">
        ...
        <a href="/organizator/documente" class="sidebar-link <?= $currentPage === 'documents' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 m-2 rounded-xl text-sm font-medium <?= $currentPage !== 'documents' ? 'text-muted' : '' ?>">
        ...
        <div class="pt-4 mt-4 border-t border-border">
            ...
            <a href="/organizator/servicii" class="sidebar-link <?= $currentPage === 'services' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 m-2 rounded-xl text-sm font-medium <?= $currentPage !== 'services' ? 'text-muted' : '' ?>">
            ...
            <a href="/organizator/promo" class="sidebar-link <?= $currentPage === 'promo' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 m-2 rounded-xl text-sm font-medium <?= $currentPage !== 'promo' ? 'text-muted' : '' ?>">
        ...
        <div class="pt-4 mt-4 border-t border-border">
            ...
            <a href="/organizator/facturare" class="sidebar-link <?= $currentPage === 'billing' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 m-2 rounded-xl text-sm font-medium <?= $currentPage !== 'billing' ? 'text-muted' : '' ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                Facturare
            </a>
            <a href="/organizator/setari" class="sidebar-link <?= $currentPage === 'settings' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 m-2 rounded-xl text-sm font-medium <?= $currentPage !== 'settings' ? 'text-muted' : '' ?>">
            ...
            <a href="/organizator/help" class="sidebar-link <?= $currentPage === 'help' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 m-2 rounded-xl text-sm font-medium <?= $currentPage !== 'help' ? 'text-muted' : '' ?>">
