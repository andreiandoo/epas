...
?>
    ...
    <section class="bg-gradient-to-br from-slate-800 to-slate-900 py-20 md:py-24 px-6 md:px-12 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p class="text-lg md:text-xl text-white/70 leading-relaxed max-w-2xl mx-auto">Suntem o echipa pasionata de tehnologie si evenimente, dedicata sa transformam modul in care romanii descopera si participa la evenimente.</p>
        </div>
    </section>
    ...
    <main class="max-w-6xl mx-auto px-6 md:px-12 py-16 md:py-20">
        ...
        <section class="mb-24">
            ...
            <div class="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
                <div>
                    <h2 class="text-3xl md:text-4xl font-extrabold text-slate-800 mb-6 leading-tight">Am inceput cu o idee simpla</h2>
                ...
                <div class="bg-gradient-to-br from-primary to-red-800 rounded-3xl p-12 md:p-16 flex items-center justify-center min-h-[400px] relative overflow-hidden">
                    ...
                    <svg class="w-28 h-28 md:w-32 md:h-32 text-white opacity-90" viewBox="0 0 48 48" fill="none">
            ...
            <!-- Stats Grid -->
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mt-14">
                <div class="bg-white rounded-2xl p-6 md:p-8 text-center border border-slate-200 hover:-translate-y-1 hover:shadow-xl transition-all">
                ...
                <div class="bg-white rounded-2xl p-6 md:p-8 text-center border border-slate-200 hover:-translate-y-1 hover:shadow-xl transition-all">
                    <div class="text-4xl md:text-5xl font-extrabold text-primary mb-2">100K+</div>
                    <div class="text-sm md:text-[15px] text-slate-500 font-medium">Bilete vandute</div>
                </div>
                <div class="bg-white rounded-2xl p-6 md:p-8 text-center border border-slate-200 hover:-translate-y-1 hover:shadow-xl transition-all">
                    <div class="text-4xl md:text-5xl font-extrabold text-primary mb-2">200+</div>
        ...
        <section class="mb-24">
            ...
            <div class="grid md:grid-cols-2 gap-6 md:gap-8">
                <div class="bg-white rounded-3xl p-8 md:p-10 border border-slate-200">
                    <div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center mb-6 text-primary">
                    ...
                    <h3 class="text-2xl font-bold text-slate-800 mb-4">Misiunea noastra</h3>
                    <p class="text-base text-slate-500 leading-relaxed">Sa democratizam accesul la tehnologie de ticketing de calitate pentru toti organizatorii de evenimente din Romania, indiferent de marimea lor.</p>
                </div>
                <div class="bg-gradient-to-br from-slate-800 to-slate-700 rounded-3xl p-8 md:p-10">
                    <div class="w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center mb-6 text-white">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-4">Viziunea noastra</h3>
                    <p class="text-base text-white/70 leading-relaxed">Sa devenim platforma preferata de ticketing din Europa de Est, recunoscuta pentru inovatie, fiabilitate si focus pe comunitate.</p>
                </div>
            </div>
        </section>
        ...
        <section class="mb-24">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                <div class="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 hover:border-primary hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/10 transition-all">
                    <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center mb-5 text-primary">
                    ...
                    <h4 class="text-lg font-bold text-slate-800 mb-3">Excelenta</h4>
                    <p class="text-sm text-slate-500 leading-relaxed">Ne straduim sa livram cea mai buna experienta posibila in fiecare detaliu al platformei noastre.</p>
                </div>
                <div class="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 hover:border-primary hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/10 transition-all">
                    <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center mb-5 text-primary">
                    ...
                    <h4 class="text-lg font-bold text-slate-800 mb-3">Comunitate</h4>
                    <p class="text-sm text-slate-500 leading-relaxed">Construim impreuna cu organizatorii si participantii. Feedback-ul lor ne ghideaza dezvoltarea.</p>
                </div>
                <div class="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 hover:border-primary hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/10 transition-all">
                    <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center mb-5 text-primary">
                    ...
                    <h4 class="text-lg font-bold text-slate-800 mb-3">Inovatie</h4>
                    <p class="text-sm text-slate-500 leading-relaxed">Adoptam cele mai noi tehnologii pentru a oferi solutii moderne si eficiente.</p>
                </div>
                <div class="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 hover:border-primary hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/10 transition-all">
                    <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center mb-5 text-primary">
                    ...
                    <h4 class="text-lg font-bold text-slate-800 mb-3">Incredere</h4>
                    <p class="text-sm text-slate-500 leading-relaxed">Securitatea datelor si a tranzactiilor este prioritatea noastra numarul unu.</p>
                </div>
                <div class="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 hover:border-primary hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/10 transition-all">
                    <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center mb-5 text-primary">
                    ...
                    <h4 class="text-lg font-bold text-slate-800 mb-3">Transparenta</h4>
                    <p class="text-sm text-slate-500 leading-relaxed">Comunicam deschis preturile, politicile si orice schimbare care afecteaza utilizatorii.</p>
                </div>
                <div class="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 hover:border-primary hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/10 transition-all">
                    <div class="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 flex items-center justify-center mb-5 text-primary">
                    ...
                    <h4 class="text-lg font-bold text-slate-800 mb-3">Sustenabilitate</h4>
                    <p class="text-sm text-slate-500 leading-relaxed">Promovam bilete digitale si practici eco-friendly in industria evenimentelor.</p>
                </div>
            </div>
        </section>
        ...
        <section class="mb-24">
            <div class="text-center mb-12">
                ...
                <h2 class="text-3xl md:text-4xl font-extrabold text-slate-800 mb-3">Oamenii din spatele AmBilet</h2>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                <div class="text-center">
                    <div class="w-36 h-36 md:w-40 md:h-40 rounded-full bg-gradient-to-br from-slate-200 to-slate-300 mx-auto mb-5 flex items-center justify-center text-4xl md:text-5xl font-bold text-slate-400 relative overflow-hidden">
                        <div class="absolute inset-1 rounded-full border-2 border-dashed border-slate-300"></div>
                        AP
                    </div>
                    <div class="text-lg font-bold text-slate-800 mb-1">Alexandru Popescu</div>
                    <div class="text-sm text-primary font-medium mb-3">Co-fondator & CEO</div>
                    <div class="flex gap-2 justify-center">
                        <a href="#" class="w-9 h-9 flex items-center justify-center bg-slate-100 rounded-lg text-slate-500 hover:bg-primary hover:text-white transition-all">
                ...
                <div class="text-center">
                    ...
                    <div class="text-lg font-bold text-slate-800 mb-1">Maria Ionescu</div>
                    <div class="text-sm text-primary font-medium mb-3">Co-fondator & CTO</div>
                    <div class="flex gap-2 justify-center">
                        <a href="#" class="w-9 h-9 flex items-center justify-center bg-slate-100 rounded-lg text-slate-500 hover:bg-primary hover:text-white transition-all">
                            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
                        </a>
                ...
                <div class="text-center">
                    ...
                    <div class="text-lg font-bold text-slate-800 mb-1">Andrei Dumitrescu</div>
                    <div class="text-sm text-primary font-medium mb-3">Head of Product</div>
                    <div class="flex gap-2 justify-center">
                        <a href="#" class="w-9 h-9 flex items-center justify-center bg-slate-100 rounded-lg text-slate-500 hover:bg-primary hover:text-white transition-all">
                            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
                        </a>
                ...
                <div class="text-center">
                    ...
                    <div class="text-lg font-bold text-slate-800 mb-1">Elena Stan</div>
                    <div class="text-sm text-primary font-medium mb-3">Customer Success</div>
                    <div class="flex gap-2 justify-center">
                        <a href="#" class="w-9 h-9 flex items-center justify-center bg-slate-100 rounded-lg text-slate-500 hover:bg-primary hover:text-white transition-all">
                            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
                        </a>
        ...
        <section class="mb-24">
            ...
            <div class="relative pl-10">
                ...
                <div class="relative pb-12">
                    ...
                    <div class="text-sm font-bold text-primary mb-2">Ianuarie 2024</div>
                    <div class="text-xl font-bold text-slate-800 mb-2">Fondarea AmBilet</div>
                ...
                <div class="relative pb-12">
                    <div class="absolute -left-10 top-1 w-4 h-4 rounded-full bg-primary border-[3px] border-slate-50 shadow-[0_0_0_3px_rgba(165,28,48,0.2)]"></div>
                    <div class="text-sm font-bold text-primary mb-2">Martie 2024</div>
                    <div class="text-xl font-bold text-slate-800 mb-2">Lansarea platformei</div>
                ...
                <div class="relative pb-12">
                    <div class="absolute -left-10 top-1 w-4 h-4 rounded-full bg-primary border-[3px] border-slate-50 shadow-[0_0_0_3px_rgba(165,28,48,0.2)]"></div>
                    <div class="text-sm font-bold text-primary mb-2">Iunie 2024</div>
                    <div class="text-xl font-bold text-slate-800 mb-2">100 de organizatori</div>
                    <div class="text-[15px] text-slate-500 leading-relaxed">Am atins milestone-ul de 100 de organizatori activi pe platforma.</div>
                </div>
                <div class="relative">
                    <div class="absolute -left-10 top-1 w-4 h-4 rounded-full bg-primary border-[3px] border-slate-50 shadow-[0_0_0_3px_rgba(165,28,48,0.2)]"></div>
                    <div class="text-sm font-bold text-primary mb-2">Decembrie 2024</div>
                    <div class="text-xl font-bold text-slate-800 mb-2">100.000 de bilete vandute</div>
        ...
        <section class="bg-gradient-to-br from-slate-800 to-slate-700 rounded-[32px] p-12 md:p-20 text-center relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <p class="text-lg text-white/70 mb-8 max-w-lg mx-auto">Vrei sa faci parte din echipa AmBilet sau sa colaborezi cu noi?</p>
