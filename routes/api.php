...
// Artist/Venue Favorites (uses CustomerFavoritesController)
    ...
    Route::post('/orders/{order}/send-tickets', [MarketplaceOrdersController::class, 'sendTickets'])
...
Route::prefix('marketplace-client/organizer')->middleware(['throttle:120,1', 'marketplace.auth'])->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('/events/{event}/leisure/sales/range-csv', [OrganizerLeisureController::class, 'salesRangeCsv'])
            ->whereNumber('event')
            ->name('api.marketplace-client.organizer.leisure.sales.range-csv');
        ...
        Route::get('/events/{event}/leisure/issuers', [OrganizerLeisureController::class, 'issuersShow'])
            ->whereNumber('event')
            ->name('api.marketplace-client.organizer.leisure.issuers.show');
        Route::put('/events/{event}/leisure/issuers', [OrganizerLeisureController::class, 'issuersUpdate'])
            ->whereNumber('event')
            ->name('api.marketplace-client.organizer.leisure.issuers.update');
        Route::get('/events/{event}/leisure/participants', [OrganizerLeisureController::class, 'participants'])
            ->whereNumber('event')
            ->name('api.marketplace-client.organizer.leisure.participants');
        Route::get('/events/{event}/leisure/sales-timeline', [OrganizerLeisureController::class, 'salesTimeline'])
            ->whereNumber('event')
            ->name('api.marketplace-client.organizer.leisure.sales-timeline');
        Route::get('/events/{event}/leisure/dashboard/live', [OrganizerLeisureController::class, 'dashboardLive'])
            ->whereNumber('event')
            ->name('api.marketplace-client.organizer.leisure.dashboard.live');
        Route::get('/events/{event}/leisure/raport', [OrganizerLeisureController::class, 'raport'])
            ->whereNumber('event')
            ->name('api.marketplace-client.organizer.leisure.raport');
        ...
        Route::post('/invitations/hold-seats', [OrganizerInvitationsController::class, 'holdSeats'])
            ->name('api.marketplace-client.organizer.invitations.hold-seats');
        Route::delete('/invitations/hold-seats', [OrganizerInvitationsController::class, 'releaseSeats'])
            ->name('api.marketplace-client.organizer.invitations.release-seats');
        ...
        Route::get('/invitations/{batch}/invites/{invite}/download', [OrganizerInvitationsController::class, 'downloadInvite'])
            ->name('api.marketplace-client.organizer.invitations.download-invite');
...
Route::prefix('marketplace-client/venue-owner')->middleware(['throttle:120,1', 'marketplace.auth'])->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'venue.owner'])->group(function () {
        ...
        Route::get('/link-organizer', [VenueOwnerAuthController::class, 'linkOrganizer'])
            ->name('api.marketplace-client.venue-owner.link-organizer');
...
Route::prefix('tenant-client')->middleware(['throttle:120,1', 'tenant.client.cors'])->group(function () {
    ...
    Route::get('/catalog/cities', [\App\Http\Controllers\Api\TenantClient\CatalogController::class, 'cities'])
        ->name('api.tenant-client.catalog.cities');
