...
|--------------------------------------------------------------------------
|
| API endpoints for customer profiling, segmentation, event targeting,
| audience export to ad platforms, and campaign management
|
*/

Route::prefix('audience')->middleware(['throttle:api'])->group(function () {
    // Customer Profiles
    Route::get('/profiles', [App\Http\Controllers\Api\AudienceTargetingController::class, 'listProfiles'])
        ->name('api.audience.profiles.index');

    Route::get('/profiles/{customerId}', [App\Http\Controllers\Api\AudienceTargetingController::class, 'getProfile'])
        ->name('api.audience.profiles.show');

    Route::post('/profiles/rebuild', [App\Http\Controllers\Api\AudienceTargetingController::class, 'rebuildProfiles'])
        ->name('api.audience.profiles.rebuild');

    // Segments
    Route::get('/segments', [App\Http\Controllers\Api\AudienceTargetingController::class, 'listSegments'])
        ->name('api.audience.segments.index');

    Route::post('/segments', [App\Http\Controllers\Api\AudienceTargetingController::class, 'createSegment'])
        ->name('api.audience.segments.store');

    Route::get('/segments/{id}', [App\Http\Controllers\Api\AudienceTargetingController::class, 'getSegment'])
        ->name('api.audience.segments.show');

    Route::post('/segments/preview', [App\Http\Controllers\Api\AudienceTargetingController::class, 'previewSegment'])
        ->name('api.audience.segments.preview');

    Route::post('/segments/{id}/refresh', [App\Http\Controllers\Api\AudienceTargetingController::class, 'refreshSegment'])
        ->name('api.audience.segments.refresh');

    Route::get('/segments/criteria/fields', [App\Http\Controllers\Api\AudienceTargetingController::class, 'getCriteriaFields'])
        ->name('api.audience.segments.criteria-fields');

    // Event Targeting
    Route::get('/events/{eventId}/recommendations', [App\Http\Controllers\Api\AudienceTargetingController::class, 'getEventRecommendations'])
        ->name('api.audience.events.recommendations');

    Route::post('/events/{eventId}/create-segment', [App\Http\Controllers\Api\AudienceTargetingController::class, 'createEventSegment'])
        ->name('api.audience.events.create-segment');

    Route::post('/events/{eventId}/generate-recommendations', [App\Http\Controllers\Api\AudienceTargetingController::class, 'generateRecommendations'])
        ->name('api.audience.events.generate-recommendations');

    Route::get('/events/{eventId}/recommendation-stats', [App\Http\Controllers\Api\AudienceTargetingController::class, 'getEventRecommendationStats'])
        ->name('api.audience.events.recommendation-stats');

    Route::post('/recommendations/track-click', [App\Http\Controllers\Api\AudienceTargetingController::class, 'trackRecommendationClick'])
        ->name('api.audience.recommendations.track-click');

    // Exports
    Route::get('/exports/platforms', [App\Http\Controllers\Api\AudienceTargetingController::class, 'getExportPlatforms'])
        ->name('api.audience.exports.platforms');

    Route::get('/exports', [App\Http\Controllers\Api\AudienceTargetingController::class, 'listExports'])
        ->name('api.audience.exports.index');

    Route::post('/exports/meta', [App\Http\Controllers\Api\AudienceTargetingController::class, 'exportToMeta'])
        ->name('api.audience.exports.meta');

    Route::post('/exports/google', [App\Http\Controllers\Api\AudienceTargetingController::class, 'exportToGoogle'])
        ->name('api.audience.exports.google');

    Route::post('/exports/tiktok', [App\Http\Controllers\Api\AudienceTargetingController::class, 'exportToTikTok'])
        ->name('api.audience.exports.tiktok');

    Route::post('/exports/brevo', [App\Http\Controllers\Api\AudienceTargetingController::class, 'exportToBrevo'])
        ->name('api.audience.exports.brevo');

    // Campaigns
    Route::get('/campaigns', [App\Http\Controllers\Api\AudienceTargetingController::class, 'listCampaigns'])
        ->name('api.audience.campaigns.index');

    Route::post('/campaigns', [App\Http\Controllers\Api\AudienceTargetingController::class, 'createCampaign'])
        ->name('api.audience.campaigns.store');

    Route::get('/campaigns/{id}', [App\Http\Controllers\Api\AudienceTargetingController::class, 'getCampaign'])
        ->name('api.audience.campaigns.show');

    Route::post('/campaigns/{id}/launch', [App\Http\Controllers\Api\AudienceTargetingController::class, 'launchCampaign'])
        ->name('api.audience.campaigns.launch');

    Route::get('/campaigns/{id}/stats', [App\Http\Controllers\Api\AudienceTargetingController::class, 'getCampaignStats'])
        ->name('api.audience.campaigns.stats');

    // Dashboard
    Route::get('/dashboard', [App\Http\Controllers\Api\AudienceTargetingController::class, 'getDashboard'])
        ->name('api.audience.dashboard');
});
