...
<main class="max-w-6xl px-6 py-10 mx-auto">
    <!-- Stats Bar -->
    <div class="flex justify-center gap-12 py-8 mb-12 bg-white border shadow-sm rounded-2xl border-border">
    ...
    <section class="mb-16">
        ...
        <div id="featuredCities" class="grid grid-cols-3 gap-6">
    ...
    <section class="mb-16">
        ...
        <div id="citiesGrid" class="grid grid-cols-4 gap-5">
            <!-- Generated by JS -->
        </div>
    </section>
    ...
    <section class="mb-16">
        ...
        <div id="regionsGrid" class="grid grid-cols-3 gap-5">
            <!-- Generated by JS -->
        </div>
    </section>
