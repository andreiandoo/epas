...
<section class="hero" style="max-width:1200px;margin:0 auto;">
  ...
  <div class="hero-content">
    <div class="hero-eyebrow"><?= (defined('HOME_SUBTITLE') && HOME_SUBTITLE) ? htmlspecialchars(HOME_SUBTITLE) : htmlspecialchars(ORG_NAME) ?></div>
    <h1><?= (defined('HOME_TITLE') && HOME_TITLE) ? HOME_TITLE : 'Alege spectacolul.<br>Ia-ți <em>biletul.</em>' ?></h1>
    <div class="hero-meta">
      <span>
      ...
      <?php
        $loc = (defined('ORG_ADDRESS') && ORG_ADDRESS) ? ORG_ADDRESS : $orgLocation;
        if ($loc): ?>
      <span>
