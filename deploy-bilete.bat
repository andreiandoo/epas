...
:: ============================================================
:: Deploy bilete.online Script
:: Pushes bileteonline folder contents to bilete branch root
:: Target: bilete.online (cPanel git deploy)
:: ============================================================

set "SOURCE_DIR=epas\resources\marketplaces\bileteonline"
set "TARGET_BRANCH=bilete"
set "TEMP_DIR=%TEMP%\bilete-deploy-%RANDOM%"
set "REPO_URL=https://github.com/andreiandoo/epas.git"

echo.
echo ========================================
echo   bilete.online Deploy Script
echo ========================================
echo.
...
if "%COMMIT_MSG%"=="" (
    ...
    set "COMMIT_MSG=Deploy bilete !datetime:~0,4!-!datetime:~4,2!-!datetime:~6,2! !datetime:~8,2!:!datetime:~10,2!"
)
...
echo [2/7] Cloning bilete branch...
...
echo [8/8] Resetting OPcache on bilete.online (waits 8s for cPanel auto-pull)...
timeout /t 8 /nobreak >nul
curl -s -o nul -w "       opcache-reset HTTP %%{http_code}\n" "https://bilete.online/opcache-reset.php?t=deploy" 2>nul

echo.
echo ========================================
echo   Deploy completed successfully!
echo   Branch: %TARGET_BRANCH%
echo   Target: bilete.online
