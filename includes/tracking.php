 ...
 * `bileteonline_active_organizer` cookie set on event pages) to also pull and append
 * the organizer's own tracking pixels â€” used so an organizer can follow a
 * customer through cart â†’ checkout â†’ thank-you without losing attribution.
 *
