...
<footer class="px-4 py-4 bg-slate-800 md:px-6 mobile:rounded-none mobile:px-0">
    <div class="flex flex-col items-center justify-between max-w-6xl gap-4 mx-auto md:flex-row md:gap-5">
        ...
        <div class="flex flex-col items-center gap-3 md:flex-row md:gap-6 mobile:w-full">
            <p class="text-sm mobile:hidden text-white/90">&copy; <?= $currentYear ?> <?= SITE_NAME ?>. Toate drepturile rezervate.</p>
            <div class="flex flex-wrap items-center justify-center gap-3 md:gap-5 mobile:w-full mobile:border-b mobile:pb-4 mobile:border-slate-600">
                <a href="/ajutor" class="text-sm transition-colors text-white/90 hover:text-white">Ajutor</a>
                <a href="/faq" class="text-sm transition-colors text-white/90 hover:text-white">FAQ</a>
                <a href="/termeni" class="text-sm transition-colors text-white/90 hover:text-white">Termeni</a>
                <a href="/confidentialitate" class="text-sm transition-colors text-white/90 hover:text-white">Confidentialitate</a>
                <a href="/contact" class="text-sm transition-colors text-white/90 hover:text-white">Contact</a>
            </div>
        </div>
        ...
        <div class="flex items-center gap-4 mobile:w-full mobile:justify-between mobile:px-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?= htmlspecialchars($socialLinks['instagram']) ?>" target="_blank" rel="noopener" title="Instagram" class="flex items-center justify-center transition-all rounded-md w-7 h-7 bg-white/10 text-white/90 hover:bg-primary hover:text-white mobile:w-10 mobile:h-10">
                ...
                <a href="<?= htmlspecialchars($socialLinks['tiktok']) ?>" target="_blank" rel="noopener" title="TikTok" class="items-center justify-center hidden transition-all rounded-md w-7 h-7 bg-white/10 text-white/90 hover:bg-primary hover:text-white mobile:w-10 mobile:h-10">
