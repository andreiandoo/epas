...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 flex flex-col w-64 transform -translate-x-full bg-white border-r sidebar lg:static border-border lg:translate-x-0">
    ...
    <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
        <a href="/organizator/dashboard" class="sidebar-link <?= $currentPage === 'dashboard' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium <?= $currentPage !== 'dashboard' ? 'text-muted' : '' ?>">
        ...
        <a href="/organizator/sales" class="sidebar-link <?= $currentPage === 'sales' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium <?= $currentPage !== 'sales' ? 'text-muted' : '' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"/></svg>
            Vanzari bilete
        </a>
        <a href="/organizator/participants" class="sidebar-link <?= $currentPage === 'participants' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium <?= $currentPage !== 'participants' ? 'text-muted' : '' ?>">
        ...
        <a href="/organizator/finance" class="sidebar-link <?= $currentPage === 'finance' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium <?= $currentPage !== 'finance' ? 'text-muted' : '' ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            Finante
        </a>
        <a href="/organizator/documents" class="sidebar-link <?= $currentPage === 'documents' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium <?= $currentPage !== 'documents' ? 'text-muted' : '' ?>">
        ...
        <div class="pt-4 mt-4 border-t border-border">
            ...
            <a href="/organizator/services" class="sidebar-link <?= $currentPage === 'services' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium <?= $currentPage !== 'services' ? 'text-muted' : '' ?>">
            ...
            <a href="/organizator/email" class="sidebar-link <?= $currentPage === 'email' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium <?= $currentPage !== 'email' ? 'text-muted' : '' ?>">
        ...
        <div class="pt-4 mt-4 border-t border-border">
            ...
            <a href="/organizator/team" class="sidebar-link <?= $currentPage === 'team' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium <?= $currentPage !== 'team' ? 'text-muted' : '' ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                Echipa
            </a>
            <a href="/organizator/billing" class="sidebar-link <?= $currentPage === 'billing' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium <?= $currentPage !== 'billing' ? 'text-muted' : '' ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                Facturare
            </a>
            <a href="/organizator/settings" class="sidebar-link <?= $currentPage === 'settings' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium <?= $currentPage !== 'settings' ? 'text-muted' : '' ?>">
            ...
            <a href="/organizator/api-docs" class="sidebar-link <?= $currentPage === 'api-docs' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium <?= $currentPage !== 'api-docs' ? 'text-muted' : '' ?>">
