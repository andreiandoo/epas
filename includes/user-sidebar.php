...
<!-- Mobile Menu Toggle -->
<button id="mobile-sidebar-toggle" class="mobile:hidden fixed z-40 justify-center text-white rounded-full items-center gap-x-2 shadow-lg lg:hidden bottom-4 right-0 left-0 mx-auto w-[90%] h-14 bg-primary">
