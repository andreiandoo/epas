...
<footer class="bg-gradient-to-br from-slate-900 to-slate-800 px-4 py-3.5 md:px-6 rounded-b-xl border-t border-primary/30">
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 md:gap-5">
        <!-- Left: Brand & Links -->
        <div class="flex flex-col md:flex-row items-center gap-3 md:gap-5">
            <div class="flex items-center gap-2.5">
                <a href="/" class="flex items-center gap-1.5 no-underline">
                    <div class="w-6 h-6 bg-gradient-to-br from-primary to-red-600 rounded flex items-center justify-center text-xs font-extrabold text-white">A</div>
            ...
            <div class="flex items-center gap-4">
                <a href="/organizer/docs" class="flex items-center gap-1.5 text-xs text-white/50 hover:text-white transition-colors">
                ...
                <a href="/organizer/api" class="flex items-center gap-1.5 text-xs text-white/50 hover:text-white transition-colors">
                ...
                <a href="/organizer/terms" class="flex items-center gap-1.5 text-xs text-white/50 hover:text-white transition-colors">
        ...
        <div class="flex items-center gap-3">
            <div class="flex items-center gap-1.5 text-[10px] text-white/30">
                Powered by
                <a href="https://tixello.com" target="_blank" class="flex items-center gap-1 text-white/40 hover:text-white font-semibold transition-colors">
            ...
            <a href="/organizer/support" class="flex items-center gap-1.5 px-3 py-1.5 bg-white/5 border border-white/10 rounded-md text-[11px] font-semibold text-white/60 hover:bg-white/10 hover:text-white transition-all">
