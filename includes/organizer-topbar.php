...
<header class="sticky top-0 z-50 border-b border-slate-700 bg-slate-900">
    <div class="flex items-center justify-between h-16 px-4 lg:px-8">
        <!-- Mobile menu button -->
        <button onclick="toggleSidebar()" class="p-2 -ml-2 transition-colors rounded-lg lg:hidden bg-surface">
        ...
        <!-- Navigare POS cashier (afisata doar cand user-ul are leisure_role=pos_cashier) -->
        <div id="pos-cashier-nav" class="hidden flex-1 items-center justify-center gap-2">
            <a href="/organizator/leisure-pos" data-nav-pos class="px-4 py-2 text-sm font-semibold rounded-xl border border-slate-700 text-white hover:bg-slate-800 transition-colors flex items-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                <span>🎫 Emite bilete</span>
            </a>
            <a href="/organizator/leisure-dashboard" data-nav-dashboard class="px-4 py-2 text-sm font-semibold rounded-xl border border-slate-700 text-white hover:bg-slate-800 transition-colors flex items-center gap-2">
        ...
        (function(){
            ...
            function applyPOSCashierUI() {
                ...
                if (path === '/organizator/leisure-pos' && posBtn) {
                    posBtn.classList.add('bg-primary', 'border-primary');
                }
                if (path === '/organizator/leisure-dashboard' && dashBtn) {
        ...
        <div class="flex items-center gap-2">
            <div data-account-switcher="organizer" class="amb-acct amb-acct--dark" hidden></div>
            <!-- Quick Create (ascuns pentru organizatori leisure) -->
            <a data-org-show="standard" href="/organizator/events?action=create" style="display:none" class="items-center hidden gap-2 px-4 py-2 text-sm font-semibold text-white btn btn-primary bg-primary sm:flex rounded-xl mobile:flex">
