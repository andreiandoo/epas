...
?>
    ...
    <!-- Reservation Timer -->
    <div id="timer-bar" class="hidden border-b bg-warning/10 border-warning/20 mobile:sticky mobile:top-18 mobile:bg-warning mobile:z-20">
                ...
                <div id="checkout-form" class="hidden">
                    ...
                    <div class="p-6 bg-white border rounded-2xl border-border">
                        ...
                        <div class="space-y-3">
                            ...
                            <label class="flex items-center gap-4 p-4 border-2 cursor-pointer payment-option selected border-border rounded-xl">
                                ...
                                <div class="flex items-center justify-between flex-1">
                                    ...
                                    <div class="flex items-center gap-2 mobile:hidden">
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/5/5c/Visa_Inc._logo_%282021%E2%80%93present%29.svg" alt="Visa" class="h-5">
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Mastercard-logo.svg/200px-Mastercard-logo.svg.png" alt="Mastercard" class="h-5">
                                    </div>
                                </div>
                            ...
                            <label id="cultural-card-option" class="flex items-center hidden gap-4 p-4 border-2 cursor-pointer payment-option border-border rounded-xl">
                                <div class="payment-radio"></div>
                                <div class="flex items-center justify-between flex-1">
                                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex flex-wrap items-center gap-3 px-1 mt-4">
                            ...
                            <div class="flex items-center gap-1.5 px-2.5 py-1 bg-white border rounded-lg border-border">
                                ...
                                <span class="text-[11px] font-medium text-secondary mobile:text-base">Google Pay</span>
                            </div>
                            <div class="flex items-center gap-1 px-2.5 py-1 bg-black rounded-lg">
                                <svg class="h-3 mobile:h-5" viewBox="0 0 24 24" fill="white">
                                    <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
                                </svg>
                                <span class="text-[11px] font-medium text-white mobile:text-base">Pay</span>
                            </div>
                        </div>
