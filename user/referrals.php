            ...
            <div class="relative p-6 mb-6 overflow-hidden text-white lg:p-10 rounded-2xl bg-gradient-to-br from-secondary to-gray-900">
                ...
                <div class="relative z-10 grid gap-8 lg:grid-cols-2 lg:items-center">
                    ...
                    <div class="p-5 rounded-xl bg-white/5">
                        <div class="mb-3 text-xs font-semibold tracking-widest text-gray-400 uppercase">Link-ul tau personal de invitatie</div>
                        <div class="flex gap-2 mb-4 mobile:flex-col">
                        ...
                        <div class="flex gap-2">
                            <button class="flex items-center justify-center flex-1 gap-2 px-4 py-3 text-sm font-medium text-white transition-colors border rounded-lg mobile:p-2 mobile:text-xs border-white/20 hover:bg-blue-600 hover:border-blue-600" onclick="shareOnFacebook()">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                                Facebook
                            </button>
                            <button class="flex items-center justify-center flex-1 gap-2 px-4 py-3 text-sm font-medium text-white transition-colors border rounded-lg mobile:p-2 mobile:text-xs border-white/20 hover:bg-green-600 hover:border-green-600" onclick="shareOnWhatsApp()">
                            ...
                            <button class="flex items-center justify-center flex-1 gap-2 px-4 py-3 text-sm font-medium text-white transition-colors border rounded-lg mobile:p-2 mobile:text-xs border-white/20 hover:bg-red-600 hover:border-red-600" onclick="shareByEmail()">
            ...
            <div class="grid grid-cols-2 gap-4 mb-6 lg:grid-cols-4">
                <div class="p-5 text-center bg-white border rounded-xl border-border">
                    <div class="flex items-center justify-center mx-auto gap-x-2">
                        <div class="text-3xl font-extrabold text-secondary" id="stat-invited">0</div>
                ...
                <div class="p-5 text-center bg-white border rounded-xl border-border">
                    <div class="flex items-center justify-center mx-auto gap-x-2">
                        <div class="text-3xl font-extrabold text-secondary" id="stat-completed">0</div>
                ...
                <div class="p-5 text-center bg-white border rounded-xl border-border">
                    <div class="flex items-center justify-center mx-auto gap-x-2">
                        <div class="text-3xl font-extrabold text-secondary" id="stat-pending">0</div>
    ...
    renderReferrals(referrals) {
        ...
        container.innerHTML = referrals.map(ref => `
            <div class="flex flex-wrap items-center gap-4 p-5 transition-colors border-b border-surface last:border-0 hover:bg-surface/50">
                <div class="flex items-center justify-center flex-shrink-0 font-semibold text-white rounded-full w-11 h-11 bg-gradient-to-br from-purple-500 to-pink-500">${ref.initials}</div>
