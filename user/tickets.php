...
<?php require_once dirname(__DIR__) . '/includes/user-wrap.php'; ?>
        ...
        <div id="empty-state" class="hidden py-16 text-center">
            ...
            <a href="/evenimente" class="btn btn-primary bg-primary">
        ...
        <div id="qr-modal-backdrop" class="qr-modal-backdrop no-print" onclick="UserTickets.hideQRModal(event)">
            <div class="qr-modal" onclick="event.stopPropagation()">
                <button onclick="UserTickets.hideQRModal()" class="absolute text-gray-400 top-4 right-4 hover:text-gray-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
                </button>
                <h3 id="qr-modal-title" class="mb-1 text-lg font-bold text-secondary"></h3>
                <p id="qr-modal-attendee" class="mb-2 text-sm text-muted"></p>
