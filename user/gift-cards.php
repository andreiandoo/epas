    ...
    <div class="flex flex-col gap-6 lg:flex-row">
        ...
        <main class="flex-1 min-w-0 lg:pt-24">
            ...
            <div class="flex flex-col gap-4 mb-6 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a href="/carduri-cadou/cumpara" class="inline-flex items-center gap-2 btn btn-primary">
            ...
            <div class="flex gap-2 p-1.5 mb-6 bg-white border rounded-xl border-border w-fit">
                <button class="tab-btn active px-4 py-2 text-sm font-semibold rounded-lg transition-colors" data-tab="purchased">
                ...
                <button class="tab-btn px-4 py-2 text-sm font-semibold text-muted rounded-lg transition-colors hover:text-secondary" data-tab="received">
            ...
            <div class="tab-content active" id="tab-purchased">
                ...
                <div class="hidden p-12 text-center bg-white border rounded-2xl border-border" id="empty-purchased">
                    ...
                    <a href="/carduri-cadou/cumpara" class="btn btn-primary">Cumpara primul card cadou</a>
                </div>
            </div>
...
const GiftCardsPage = {
    ...
    renderPurchasedCard(card) {
        ...
        return `
            <div class="overflow-hidden bg-white border rounded-2xl border-border hover:shadow-lg transition-shadow">
                ...
                <div class="p-5">
                    ...
                    <div class="flex items-center gap-3 p-3 mb-4 rounded-xl bg-surface">
                        <div class="flex items-center justify-center w-9 h-9 rounded-full bg-border">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="text-sm font-semibold text-secondary truncate">${card.recipient.name}</div>
                            <div class="text-xs text-muted truncate">${card.recipient.email}</div>
                        </div>
                    </div>
                    ` : ''}
