            ...
            <div class="grid lg:grid-cols-5 gap-6">
                ...
                <div class="lg:col-span-3 space-y-6">
                    ...
                    <div class="bg-white rounded-xl lg:rounded-2xl border border-border p-4 lg:p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <a href="/cont/bilete" class="text-sm text-primary font-medium hover:underline">Vezi toate</a>
                        </div>
                    ...
                    <div class="bg-white rounded-xl lg:rounded-2xl border border-border p-4 lg:p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <a href="/" class="text-sm text-primary font-medium hover:underline">Vezi toate</a>
                        </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-xl lg:rounded-2xl border border-border p-4 lg:p-6">
                        ...
                        <div class="space-y-2">
                            <a href="/cont/bilete" class="flex items-center gap-3 p-3 bg-surface rounded-xl hover:bg-primary/10 transition-colors group">
                            ...
                            <a href="/cont/puncte" class="flex items-center gap-3 p-3 bg-surface rounded-xl hover:bg-primary/10 transition-colors group">
                    ...
                    <div class="bg-white rounded-xl lg:rounded-2xl border border-border p-4 lg:p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <a href="/cont/puncte" class="text-sm text-primary font-medium hover:underline">Toate</a>
                        </div>
...
const UserDashboard = {
    ...
    renderUpcomingEvents(tickets) {
        ...
        container.innerHTML = tickets.map(t => {
            ...
            return `
                <a href="/bilete/${event.slug || ''}" class="card-hover flex gap-4 p-3 bg-surface rounded-xl">
    ...
    renderRecommendedEvents(events) {
        ...
        if (!events.length) {
            container.innerHTML = '<p class="text-center text-muted py-8">Descopera evenimente noi</p>';
            return;
        }

        container.innerHTML = events.map(e => `
            <a href="/bilete/${e.slug}" class="card-hover group rounded-xl overflow-hidden border border-border">
