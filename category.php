...
<section id="categoryFeaturedSection" class="relative hidden overflow-hidden">
    ...
    <div class="absolute inset-0 bg-gradient-to-br from-primary via-primary/95 to-secondary/30"></div>
    <!-- Decorative elements -->
    ...
    <div class="relative px-4 py-10 mx-auto md:py-14 max-w-7xl">
        ...
        <div class="mb-8 text-center">
            <div class="inline-flex items-center gap-2 px-4 py-2 mb-4 text-xs font-bold tracking-wider uppercase rounded-full bg-white/20 text-white/90 backdrop-blur-sm">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                </svg>
                <span>Selecție Premium</span>
            </div>
            <h2 class="mb-2 text-3xl font-extrabold text-white md:text-4xl">Nu Rata Aceste Evenimente</h2>
            <p class="max-w-2xl mx-auto text-lg text-white/70">Cele mai populare evenimente din această categorie</p>
        </div>
        <!-- Events Grid -->
