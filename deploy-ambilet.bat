...
:: ============================================================
:: Deploy ambilet.ro Script
:: Pushes ambilet folder contents to ambilet branch root
:: Target: ambilet.ro (cPanel git deploy)
:: ============================================================

:: Anchor all relative paths to this script's folder (epas repo root),
:: so the script works no matter what the current directory is.
cd /d "%~dp0"

set "SOURCE_DIR=resources\marketplaces\ambilet"
set "TARGET_BRANCH=ambilet"
set "TEMP_DIR=%TEMP%\ambilet-deploy-%RANDOM%"
set "REPO_URL=https://github.com/andreiandoo/epas.git"

echo.
echo ========================================
echo   ambilet.ro Deploy Script
echo ========================================
echo.
...
echo [2/7] Cloning ambilet branch...
